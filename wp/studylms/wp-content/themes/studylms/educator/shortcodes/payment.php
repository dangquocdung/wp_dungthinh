...
if ( $payment_id ) {
	...
	<table class="edr-payment-table">
		<thead>
			<tr>
				<th><?php esc_html_e( 'Item', 'studylms' ); ?></th>
				<th><?php esc_html_e( 'Price', 'studylms' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<tr>
	...
	?>
		<form id="edr-payment-form" class="edr-form" action="<?php echo esc_url( $form_action ); ?>" method="post">
			...
			<div class="edr-form__fields">
				<div class="edr-form__legend"><?php esc_html_e( 'Payment Information', 'studylms' ); ?></div>
			...
			<div class="edr-form__actions">
				<button type="submit" class="edr-button"><?php esc_html_e( 'Continue', 'studylms' ) ?></button>
			</div>
		</form>
	<?php
}
