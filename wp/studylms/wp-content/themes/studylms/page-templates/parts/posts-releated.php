<?php
    $relate_count = studylms_get_config('number_blog_releated', 3);
    $relate_columns = studylms_get_config('releated_blog_columns', 3);
...
?>
    <div class="widget no-margin">
        <h4 class="title">
            <span><?php esc_html_e( 'Releated Posts', 'studylms' ); ?></span>
        </h4>
