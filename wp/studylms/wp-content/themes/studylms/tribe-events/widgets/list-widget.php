...
if ( $posts ) : ?>
	...
	<ol class="tribe-list-widget">
		...
		foreach ( $posts as $post ) :
			setup_postdata( $post );
			?>
			<li class="tribe-events-list-widget-events  clearfix">
				<?php
				if (
				...
				<div class="tribe-event-duration hidden">
	...
	<p class="tribe-events-widget-link">
		<a href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'View All %s', 'studylms' ), $events_label_plural ); ?></a>
	</p>

<?php
// No events were found.
else : ?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'studylms' ), $events_label_plural_lowercase ); ?></p>
<?php
endif;
