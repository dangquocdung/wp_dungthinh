...
<form action="" method="post" class="edit-account">
	...
	<p class="form-group form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'studylms' ); ?> <span class="required">*</span></label>
	...
	<p class="form-group form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'studylms' ); ?> <span class="required">*</span></label>
	...
	<p class="form-group form-row form-row-wide">
		<label for="account_email"><?php esc_html_e( 'Email address', 'studylms' ); ?> <span class="required">*</span></label>
	...
	<fieldset>
		<legend><?php esc_html_e( 'Password Change', 'studylms' ); ?></legend>
		<p class="form-group form-row form-row-thirds">
			<label for="password_current"><?php esc_html_e( 'Current Password (leave blank to leave unchanged)', 'studylms' ); ?></label>
			<input type="password" class="input-text form-control" name="password_current" id="password_current" />
		</p>
		<p class="form-group form-row form-row-thirds">
			<label for="password_1"><?php esc_html_e( 'New Password (leave blank to leave unchanged)', 'studylms' ); ?></label>
			<input type="password" class="input-text form-control" name="password_1" id="password_1" />
		</p>
		<p class="form-group form-row form-row-thirds">
			<label for="password_2"><?php esc_html_e( 'Confirm New Password', 'studylms' ); ?></label>
	...
	<p class="form-group">
		...
		<input type="submit" class="button btn-theme-color-second btn-block radius-0" name="save_account_details" value="<?php esc_html_e( 'Save changes', 'studylms' ); ?>" />
