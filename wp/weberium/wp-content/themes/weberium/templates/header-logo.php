...
$logo_img = weberium_get_mod( 'custom_logo' );
$logo_retina_img = weberium_get_mod( 'retina_logo' );
$logo_width = intval( weberium_get_mod( 'logo_width' ) );
$logo_height = intval( weberium_get_mod( 'logo_height' ) );
...
if ( $header_style == 'style-2' || $header_style == 'style-4' ) {
	$logo_img = weberium_get_mod( 'custom_logotwo' );
	$logo_retina_img = weberium_get_mod( 'retina_logotwo' );
	$logo_width = intval( weberium_get_mod( 'logotwo_width' ) );
	$logo_height = intval( weberium_get_mod( 'logotwo_height' ) );	
}

if ( $header_style == 'style-3' ) {
	$logo_img = weberium_get_mod( 'custom_logothree' );
	$logo_retina_img = weberium_get_mod( 'retina_logothree' );
	$logo_width = intval( weberium_get_mod( 'logothree_width' ) );
	$logo_height = intval( weberium_get_mod( 'logothree_height' ) );	
}
