...
if ( ! weberium_get_mod( 'footer_widgets', true ) ) return false;

// Get options
$classes = '';
$columns = weberium_get_mod( 'footer_columns', '4' );
$grid_cls = 'span_1_of_'. $columns;
$gutter = weberium_get_mod( 'footer_column_gutter', '30' );
...
<div id="footer-widgets" class="weberium-container">
	<div class="weberium-row <?php echo esc_attr( $classes ); ?>">
		<?php
		// Footer widget 1 ?>
