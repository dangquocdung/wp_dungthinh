...
if ( ! class_exists( 'Weberium_Sanitize_Data' ) ) {
	class Weberium_Sanitize_Data {
...
// Helper function runs the Weberium_Sanitize_Data class
function weberium_sanitize_data( $data = '', $type = '' ) {
	if ( $data && $type ) {
		$class = new Weberium_Sanitize_Data();
