...
wp_enqueue_script( 'weberium-fittext' );
...
if ( $animation == 'typed' ) {
	wp_enqueue_script( 'weberium-typed' );
	...
	printf(
		'<div class="weberium-fancy-text typed %10$s" data-fancy="%1$s" data-min="%2$s" data-max="%3$s">
...
if ( $animation == 'scroll' ) {
	...
	printf(
		'<div class="weberium-fancy-text scroll %5$s" data-min="%2$s" data-max="%3$s" style="%4$s">
	        %1$s
	    </div>',
	    $fancy_text,
		$min,
