...
if ( $title_font_family != 'Default' ) {
	weberium_enqueue_google_font( $title_font_family );
...
if ( $arrow == 'style-1' ) $icon_html = '<i class="nz-arrow-right"></i>';
if ( $arrow == 'style-2' ) $icon_html = '<i class="nz-arrow-right4"></i>';
if ( $arrow == 'style-3' ) $icon_html = '<i class="nz-arrow-right5"></i>';
...
printf(
	'<div class="weberium-info-list clearfix %1$s" style="%2$s">%3$s</div>',
	$cls,
	$css,
	$html 
);