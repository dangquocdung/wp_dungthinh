...
$cls = $filter_css = $filter_wrap_css  = $filter_data = '';
...
if ( $filter_font_family != 'Default' ) {
	weberium_enqueue_google_font( $filter_font_family );
...
<div class="weberium-project-grid" data-column="<?php echo esc_attr( $column ); ?>" data-column2="<?php echo esc_attr( $column2 ); ?>" data-column3="<?php echo esc_attr( $column3 ); ?>" data-column4="<?php echo esc_attr( $column4 ); ?>" data-gaph="<?php echo esc_attr( $gaph ); ?>" data-gapv="<?php echo esc_attr( $gapv ); ?>" data-filter="<?php echo esc_attr( $filter_data ); ?>">
