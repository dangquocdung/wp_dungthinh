...
if ( $grid ) {
	$content_html = sprintf( '<div class="weberium-container"><div class="hero-content">%1$s</div></div>', do_shortcode($content) );
} else {
...
if ( $showcase == 'slideshow') {
	wp_enqueue_script( 'weberium-vegas' );
	printf(
...
if ( $showcase == 'video') {
	wp_enqueue_script( 'weberium-ytplayer' );
