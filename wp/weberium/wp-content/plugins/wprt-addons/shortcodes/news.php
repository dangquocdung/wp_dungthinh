...
<div class="weberium-news <?php echo esc_attr( $cls ); ?>" data-auto="<?php echo esc_attr( $auto_scroll ); ?>" data-column="<?php echo esc_attr( $column ); ?>" data-column2="<?php echo esc_attr( $column2 ); ?>" data-column3="<?php echo esc_attr( $column3 ); ?>" data-gap="<?php echo esc_html( $gap ); ?>">
    		...
    		<div class="inner"  style="<?php echo esc_attr( $item_css ); ?>">
    			<div class="thumb-wrap">
	    			...
	    			if ( has_post_thumbnail() ) {
						...
						if ( $image_crop == 'postgrid' ) $img_size = 'weberium-post-grid';
                ...
                <div class="text-wrap" style="<?php echo esc_attr( $content_css ); ?>">
					...
					if ( get_the_title() ) {
						echo '<h3 class="title" style="'. esc_attr( $heading_css ) .'"><span><a href="'. esc_url( get_the_permalink() ) .'">'. get_the_title() .'</a></span></h3>';
					}
