...
if ( $wpex_query->have_posts() ) :
    wp_enqueue_script( 'weberium-owlcarousel' );
    echo '<div class="weberium-products clearfix '. $cls .'" data-auto="'. $auto_scroll .'" data-column="'. $column .'" data-column2="'. $column2 .'" data-column3="'. $column3 .'" data-gap="'. $gap .'">';
