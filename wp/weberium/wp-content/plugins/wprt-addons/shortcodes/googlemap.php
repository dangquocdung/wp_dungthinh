...
<script type="text/javascript">
    ...
    google.maps.event.addDomListener(window, "load", weberium_vc_gmap);
</script>';

printf('%1$s<div id="%2$s" class="weberium-google-map" style="%3$s"></div>', $html, $id, $css );