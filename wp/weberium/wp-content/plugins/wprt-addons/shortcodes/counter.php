...
if ( $number_font_family != 'Default' ) {
	weberium_enqueue_google_font( $number_font_family );
...
if ( $prefix_font_family != 'Default' ) {
	weberium_enqueue_google_font( $prefix_font_family );
...
if ( $suffix_font_family != 'Default' ) {
	weberium_enqueue_google_font( $suffix_font_family );
	$suffix_css .= 'font-family:'. $suffix_font_family .';';
}

if ( $number )
	wp_enqueue_script( 'weberium-countto' );
	wp_enqueue_script( 'weberium-appear' );
	$number_html .= sprintf(
...
printf( '<div class="weberium-counter clearfix %2$s">%1$s</div>',
	$html,
	$cls
);