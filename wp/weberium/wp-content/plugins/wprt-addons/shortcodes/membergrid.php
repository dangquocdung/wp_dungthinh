...
<div class="weberium-team-grid <?php echo esc_attr( $cls ); ?>" style="<?php echo esc_attr( $css ); ?>">
    ...
    <?php while ( $query->have_posts() ) : $query->the_post();
    	...
    	<div class="team-item clearfix" style="<?php echo esc_attr( $item_css ); ?>">
    		<div class="inner" style="<?php echo esc_attr( $inner_css ); ?>">
	        	...
	        	if ( weberium_metabox( 'facebook' ) )
        		$socials_html .= '<li class="facebook"><a target="_blank" href="'. esc_url( weberium_metabox( 'facebook' ) ) .'"><i class="craft-facebook"></i></a></li>';

        		if ( weberium_metabox( 'twitter' ) )
        		$socials_html .= '<li class="twitter"><a target="_blank" href="'. esc_url( weberium_metabox( 'twitter' ) ) .'"><i class="craft-twitter"></i></a></li>';

        		if ( weberium_metabox( 'linkedin' ) )
        		$socials_html .= '<li class="linkedin"><a target="_blank" href="'. esc_url( weberium_metabox( 'linkedin' ) ) .'"><i class="craft-linkedin"></i></a></li>';

        		if ( weberium_metabox( 'google_plus' ) )
        		$socials_html .= '<li class="google-plus"><a target="_blank" href="'. esc_url( weberium_metabox( 'google_plus' ) ) .'"><i class="craft-googleplus"></i></a></li>';

        		if ( weberium_metabox( 'instagram' ) )
        		$socials_html .= '<li class="instagram"><a target="_blank" href="'. esc_url( weberium_metabox( 'instagram' ) ) .'"><i class="craft-instagram"></i></a></li>';
	        	$socials_html .= '</ul>';
	        	endif; ?>
             	...
             	<?php if ( weberium_metabox( 'name' ) || weberium_metabox( 'position' ) || weberium_metabox( 'text' ) ) : ?>
             		<div class="text-wrap" style="<?php echo esc_attr($content_css); ?>">
				        <?php if ( weberium_metabox( 'name' ) ) : ?>
				        	...
				        	<?php echo esc_html( weberium_metabox( 'name' ) ); ?></h4>
				        <?php endif; ?>
