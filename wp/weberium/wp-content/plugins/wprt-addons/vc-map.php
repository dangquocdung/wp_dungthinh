...
function vc_add_new_para() {
	// Add Number param
	vc_add_shortcode_param( 'number', 'weberium_param_number' );
	function weberium_param_number( $settings, $value ) {
		$dependency = '';
	...
	// Add Heading param
	vc_add_shortcode_param( 'headings', 'weberium_param_heading' );
	function weberium_param_heading( $settings, $value ) {
		$dependency = '';
		$param_name = isset($settings['param_name']) ? $settings['param_name'] : '';
		$class = isset($settings['class']) ? $settings['class'] : '';
...
function vc_iconpicker_type_extraicon() {
    return array(
		array("seoking-check" => "check"),
		array("seoking-play" => "play"),
		array("seoking-alarm-clock" => "alarm-clock"),
		array("seoking-atomic" => "atomic"),
		array("seoking-bar-chart" => "bar-chart"),
		array("seoking-battery" => "battery"),
		array("seoking-battery-1" => "battery-1"),
		array("seoking-bell" => "bell"),
		array("seoking-bluetooth" => "bluetooth"),
		array("seoking-book" => "book"),
		array("seoking-box" => "box"),
		array("seoking-calculator" => "calculator"),
		array("seoking-calendar" => "calendar"),
		array("seoking-car" => "car"),
		array("seoking-chat" => "chat"),
		array("seoking-chat-1" => "chat-1"),
		array("seoking-checked" => "checked"),
		array("seoking-cloud" => "cloud"),
		array("seoking-cloud-computing" => "cloud-computing"),
		array("seoking-cloud-computing-1" => "cloud-computing-1"),
		array("seoking-compass" => "compass"),
		array("seoking-credit-card" => "credit-card"),
		array("seoking-cursor" => "cursor"),
		array("seoking-cutlery" => "cutlery"),
		array("seoking-download" => "download"),
		array("seoking-edit" => "edit"),
		array("seoking-envelope" => "envelope"),
		array("seoking-eraser" => "eraser"),
		array("seoking-eye" => "eye"),
		array("seoking-fast-forward" => "fast-forward"),
		array("seoking-favorites" => "favorites"),
		array("seoking-file" => "file"),
		array("seoking-file-1" => "file-1"),
		array("seoking-file-2" => "file-2"),
		array("seoking-file-3" => "file-3"),
		array("seoking-filter" => "filter"),
		array("seoking-flag" => "flag"),
		array("seoking-folder" => "folder"),
		array("seoking-folder-1" => "folder-1"),
		array("seoking-gamepad" => "gamepad"),
		array("seoking-heart" => "heart"),
		array("seoking-home" => "home"),
		array("seoking-id-card" => "id-card"),
		array("seoking-idea" => "idea"),
		array("seoking-image" => "image"),
		array("seoking-inbox" => "inbox"),
		array("seoking-information" => "information"),
		array("seoking-key" => "key"),
		array("seoking-laptop" => "laptop"),
		array("seoking-layers" => "layers"),
		array("seoking-like" => "like"),
		array("seoking-line-chart" => "line-chart"),
		array("seoking-loupe" => "loupe"),
		array("seoking-mail" => "mail"),
		array("seoking-map" => "map"),
		array("seoking-medal" => "medal"),
		array("seoking-megaphone" => "megaphone"),
		array("seoking-message" => "message"),
		array("seoking-message-1" => "message-1"),
		array("seoking-message-2" => "message-2"),
		array("seoking-microphone" => "microphone"),
		array("seoking-money" => "money"),
		array("seoking-monitor" => "monitor"),
		array("seoking-music" => "music"),
		array("seoking-next" => "next"),
		array("seoking-padlock" => "padlock"),
		array("seoking-padlock-1" => "padlock-1"),
		array("seoking-paint-brush" => "paint-brush"),
		array("seoking-pause" => "pause"),
		array("seoking-phone-call" => "phone-call"),
		array("seoking-photo-camera" => "photo-camera"),
		array("seoking-placeholder" => "placeholder"),
		array("seoking-planet-earth" => "planet-earth"),
		array("seoking-play-button" => "play-button"),
		array("seoking-power-button" => "power-button"),
		array("seoking-presentation" => "presentation"),
		array("seoking-printer" => "printer"),
		array("seoking-reload" => "reload"),
		array("seoking-return" => "return"),
		array("seoking-rss" => "rss"),
		array("seoking-safebox" => "safebox"),
		array("seoking-settings" => "settings"),
		array("seoking-settings-1" => "settings-1"),
		array("seoking-settings-2" => "settings-2"),
		array("seoking-share" => "share"),
		array("seoking-shield" => "shield"),
		array("seoking-shopping-cart" => "shopping-cart"),
		array("seoking-smartphone" => "smartphone"),
		array("seoking-speaker" => "speaker"),
		array("seoking-speakers" => "speakers"),
		array("seoking-trash" => "trash"),
		array("seoking-trophy" => "trophy"),
		array("seoking-upload" => "upload"),
		array("seoking-user" => "user"),
		array("seoking-user-1" => "user-1"),
		array("seoking-user-2" => "user-2"),
		array("seoking-user-3" => "user-3"),
		array("seoking-users" => "users"),
		array("seoking-video-camera" => "video-camera"),
		array("seoking-wifi" => "wifi"),
		array("seoking-zoom-in" => "zoom-in"),
		array("seoking-zoom-out" => "zoom-out")
    );
}

// Return simple fonts array
if ( ! function_exists('weberium_plugin_google_font') ) {
	function weberium_plugin_google_font() {
		if ( function_exists('weberium_google_fonts_array') ) {
			$default = array( 0 => 'Default' );
			return array_merge( $default, weberium_google_fonts_array() );
		} else {
			return array(
...
if ( ! function_exists('weberium_animation') ) {
	function weberium_animation() {
		return array(
...
if ( ! function_exists('weberium_get_icon_class') ) {
	function weberium_get_icon_class( $atts, $icon_location ) {
		// Define vars
		$icon = '';
    ...
    vc_map( array(
        ...
        'params' => array(
			...
			array(
				...
				'value'      =>  weberium_plugin_google_font(),
    ...
    'description' => esc_html__('Displaying Accordion', 'thecraft'),
		...
		'params'      => array(
			...
			array(
				...
				'value' => array(
					esc_html__( '', 'thecraft' ) => '',
					esc_html__( 'SEOKing Icons', 'thecraft' ) => 'extraicon',
	...
	vc_map( array(
	    ...
	    'params' => array(
	        ...
	        array(
				...
				'value' => '',
				'group' => esc_html__( 'Content', 'thecraft' ),
				'description'	=> esc_html__('Spacing between the icon and the heading. Ex: 20px.', 'thecraft'),
				'dependency' => array( 'element' => 'show_icon', 'value' => 'yes' ),
	        ),
			// Sub-Heading
			array(
	        ...
	        array(
				'type' => 'textfield',
				'heading' => esc_html__('Sub-Heading: Letter Spacing', 'thecraft'),
    ...
    vc_map( array(
        ...
        'params' => array(
	        ...
	        array(
				...
				'param_name' => 'padding',
				'value' => '',
				'description'	=> esc_html__('Top Right Bottom Left. Ex: 40px 50px 40px 50px', 'fundrize'),
	        ),
			array(
				'type'       => 'dropdown',
...
add_action( 'vc_before_init', function() {
    vc_map( array(
        'name' => esc_html__('Google Maps', 'thecraft'),
        'description' => esc_html__('Displaying Google Maps.', 'thecraft'),
        'base' => 'googlemap',
		'weight'	=>	180,
        'icon' => plugins_url('assets/icon.png', __FILE__),
        'category' => esc_html__('WPRT VC Addons', 'thecraft'),
        'params' => array(
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Latitude', 'thecraft' ),
				'param_name'  => 'lat',
				'description' => '<a href="http://universimmedia.pagesperso-orange.fr/geo/loc.htm" target="_blank">'. esc_html__('Here is a tool', 'thecraft').'</a> '. esc_html__('where you can find Latitude & Longitude of your location', 'thecraft'),
			),
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Longitude', 'thecraft' ),
				'param_name'  => 'lng',
				'description' => '<a href="http://universimmedia.pagesperso-orange.fr/geo/loc.htm" target="_blank">'. esc_html__('Here is a tool', 'thecraft').'</a> '. esc_html__('where you can find Latitude & Longitude of your location', 'thecraft'),
			),
			array(
				'type'       => 'textfield',
				'heading'    => esc_html__( 'Map Width', 'thecraft' ),
				'param_name' => 'width',
				'value'      => ''
			),
			array(
				'type'       => 'textfield',
				'heading'    => esc_html__( 'Map Height', 'thecraft' ),
				'param_name' => 'height',
				'value'      => 300
			),
			array(
				'type'        => 'dropdown',
				'heading'     => esc_html__( 'Zoom Level', 'thecraft' ),
				'param_name'  => 'zoom',
				'description' => esc_html__( 'Select the default zoom level for the Maps', 'thecraft' ),
			...
			array(
				'type'        => 'dropdown',
				'heading'     => esc_html__( 'Show The Marker', 'thecraft' ),
				...
				'std'		=> 'simple',
				'group' => esc_html__( 'Maker', 'thecraft' ),
			),
			array(
				'type' => 'attach_image',
				'heading' => esc_html__('Image', 'thecraft'),
