...
function crown_require_plugin() {
    ...
    $plugins = array(
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/inc/plugins/crown-addons-v1.0.1.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/inc/plugins/js_composer_6.4.0.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
