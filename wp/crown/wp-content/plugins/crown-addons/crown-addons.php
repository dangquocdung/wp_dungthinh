<?php
/**
 *    Plugin Name: Crown Addons
 *    Plugin URI: http://g5plus.net
 *    Description: Addons For Crown Theme
 *    Version: 1.0.1
 *    Author: G5
...
if (!class_exists('G5ThemeAddons')) {
	class G5ThemeAddons {
		...
		public function init() {
			...
			$this->init_modules();
			$this->setup_theme_config()->init();
			$this->setup_theme_data()->init();
			$this->setup_theme_demo()->init();
        ...
        public function admin_notices() {
            ?>
            <div class="error">
                <p><?php esc_html_e('Crown Addons is enabled but not effective. It requires G5 Core in order to work.','gta'); ?></p>
            </div>
            <?php
        }
		...
		public function includes() {
            ...
            $this->load_file($this->plugin_dir('inc/functions/portfolio.php'));
		}

		public function load_text_domain() {
			load_plugin_textdomain( 'gta', false, $this->plugin_dir('languages'));
		}
		...
		/**
		 * @return G5ThemeAddons_Setup_Theme_Config
		 */
		public function setup_theme_config() {
			return G5ThemeAddons_Setup_Theme_Config::getInstance();
		}
		...
		/**
		 * @return G5ThemeAddons_Setup_Theme_Demo
		 */
		public function setup_theme_demo() {
			return G5ThemeAddons_Setup_Theme_Demo::getInstance();
		}
