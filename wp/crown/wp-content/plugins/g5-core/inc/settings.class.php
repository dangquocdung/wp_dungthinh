...
if ( ! class_exists( 'G5Core_Settings' ) ) {
	class G5Core_Settings {
		...
		public function get_header_layout() {
			return apply_filters( 'g5core_options_header_layout', array(
		...
		public function get_footer_layout() {
			return apply_filters( 'g5core_options_footer_layout', array(
				'boxed'      => esc_html__( 'Boxed footer', 'g5-core' ),
				'full-width' => esc_html__( 'Full width footer (Boxed Content)', 'g5-core' ),
				'stretched'  => esc_html__( 'Full width footer (Stretched Content)', 'g5-core' ),
			) );
		}
        ...
        {
            $config = apply_filters('g5blog_options_post_paging_mode', array(
        ...
        {
            $config = apply_filters('g5blog_options_post_columns_gutter', array(
                'none' => esc_html__('None', 'g5-core'),
                '5' => '5px',
                '10' => '10px',
                '20' => '20px',
