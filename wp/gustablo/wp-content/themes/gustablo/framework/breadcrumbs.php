...
function wprt_breadcrumbs() {
    ...
    $home_text     = esc_html__('Home','gustablo');
    $category_text = esc_html__('Archive by Category "%s"','gustablo');
    $tax_text      = esc_html__('Archive by "%s"','gustablo');
    $tag_text      = esc_html__('Posts Tagged "%s"','gustablo');
    $author_text   = esc_html__('Articles Posted by %s','gustablo');
    $error_text    = esc_html__('Error 404','gustablo');
    $search_text   = esc_html__('Search Results for "%s" Query','gustablo');

    $blog_text   = esc_html__('Blog','gustablo');
	$gallery_text = esc_html__('Galleries','gustablo');
	$product_text = esc_html__('Products','gustablo');
    ...
    if ( get_query_var('paged') ) {
        ...
        echo '<span>'. esc_html__( 'Page','gustablo' ) .' '. get_query_var('paged') .'</span>';
