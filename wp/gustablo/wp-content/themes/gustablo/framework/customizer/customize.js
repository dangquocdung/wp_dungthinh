...
var objBg = {
	...
	featured_title_breadcrumbs_background: "#breadcrumbs",
...
var objColor = {
	...
	featured_title_breadcrumbs_color: "#breadcrumbs, #breadcrumbs a",
...
var objPadding = {
	header_search_icon_margin_one: ".header-style-1 #site-header #header-search",
	header_search_icon_margin_two_three: ".header-style-2 #site-header #header-search, .header-style-3 #site-header #header-search",
	header_search_icon_margin_four: ".header-style-4 #site-header #header-search",
	header_cart_icon_margin_one: '.header-style-1 .nav-top-cart-wrapper',
	header_cart_icon_margin_two_three: ".header-style-2 .nav-top-cart-wrapper, .header-style-3 .nav-top-cart-wrapper",
	header_cart_icon_margin_four: '.header-style-4 .nav-top-cart-wrapper',
...
var objLineHeight = {
	...
	featured_title_breadcrumbs_height: "#breadcrumbs"
}
...
var objColorBorderColor = {
	featured_title_heading_color: "#featured-title .featured-title-heading, #featured-title .featured-title-sub-heading, #featured-title .featured-title-sub-heading:before, #featured-title .featured-title-sub-heading:after",
}

$.each( objColorBorderColor, function( k, v ) {
	wp.customize(k, function(e) {
	    e.bind(function(e) {
	        var o = $(".customizer-" + k);
	        if (e) {
	            var t = '<style class="customizer-' + k + '">' + v + ' { color: ' + e + "; border-color: " + e + "; }</style>";
	            o.length ? o.replaceWith(t) : $("head").append(t)
	        } else o.remove()
	    })
	});
...
var objTopPadding = {
	...
	featured_title_top_padding: "#featured-title .featured-title-inner-wrap",
...
var objBottomPadding = {
	...
	featured_title_bottom_padding: "#featured-title .featured-title-inner-wrap",
...
wp.customize("mobile_logo_margin", function(e) {
    e.bind(function(e) {
        ...
        if (e) {
            var t = '<style class="customizer-mobile_logo_margin">@media only screen and (max-width: 991px) { .header-style-1 #site-logo-inner { margin: ' + e + "; } }</style>";
            o.length ? o.replaceWith(t) : $("head").append(t)
        } else o.remove()
    })
});
