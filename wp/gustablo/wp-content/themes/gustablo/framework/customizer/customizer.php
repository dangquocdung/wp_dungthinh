...
if ( ! class_exists( 'WPRT_Customizer' ) ) {
	class WPRT_Customizer {
		...
		public function __construct() {
			...
			$this->panels = array(
				'general' => array(
					'title' => esc_html__( 'General Options', 'gustablo' ),
				),
				'topbar' => array(
					'title' => esc_html__( 'Top Bar', 'gustablo' ),
				),
				'header' => array(
					'title' => esc_html__( 'Header', 'gustablo' ),
				),
				'featuredtitle' => array(
					'title' => esc_html__( 'Featured Title', 'gustablo' ),
				),
				'maincontent' => array(
					'title' => esc_html__( 'Main Content', 'gustablo' ),
				),
				'layout' => array(
					'title' => esc_html__( 'Layout', 'gustablo' ),
				),
				'blog' => array(
					'title' => esc_html__( 'Blog', 'gustablo' ),
				),
				'blogsingle' => array(
					'title' => esc_html__( 'Blog Single Post', 'gustablo' ),
				),
				'sidebarwidget' => array(
					'title' => esc_html__( 'Sidebar Widget', 'gustablo' ),
				),
				'galleries' => array(
					'title' => esc_html__( 'Gallery Related', 'gustablo' ),
				),
				'woocommerce' => array(
					'title' => esc_html__( 'Shop', 'gustablo' ),
				),
				'footer' => array(
					'title' => esc_html__( 'Footer', 'gustablo' ),
				),
				'footerwidget' => array(
					'title' => esc_html__( 'Footer Widget', 'gustablo' ),
				),
				'bottombar' => array(
					'title' => esc_html__( 'Bottom Bar', 'gustablo' ),
				),
			);
		...
		public static function customize_controls_print_styles() { ?>
			 <style type="text/css">
				...
				#accordion-panel-wprt_galleries > h3:before,
				...
				#accordion-panel-wprt_galleries > h3:before { content: "\f481" }
