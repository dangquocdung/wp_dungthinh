	...
	class WPRT_Typography {
		...
		public static function elements() {
			...
			$array = apply_filters( 'wprt_typography_settings', array(
				'body' => array(
					'label' => esc_html__( 'Body', 'gustablo' ),
					'target' => 'body',
					'defaults' => array(
				...
				'headings' => array(
					'label' => esc_html__( 'Headings', 'gustablo' ),
				...
				'entry_h1' => array(
					'label' => esc_html__( 'H1', 'gustablo' ),
					'target' => 'h1',
				),
				'entry_h2' => array(
					'label' => esc_html__( 'H2', 'gustablo' ),
					'target' => 'h2',
				),
				'entry_h3' => array(
					'label' => esc_html__( 'H3', 'gustablo' ),
					'target' => 'h3',
				),
				'entry_h4' => array(
					'label' => esc_html__( 'H4', 'gustablo' ),
					'target' => 'h4',
				),
				'copyright' => array(
				...
				'bottom_menu' => array(
					'label' => esc_html__( 'Bottom Menu', 'gustablo' ),
					'target' => '#bottom ul.bottom-nav > li > a',
					'exclude' => array( 'font-color' ),
					'active_callback' => 'wprt_cac_has_bottombar',
				),
				'woocommerce_product_title' => array(
					'label' => esc_html__( 'Woocommerce: Product Title', 'gustablo' ),
				...
				'woocommerce_price' => array(
					'label' => esc_html__( 'Woocommerce: Price Amount', 'gustablo' ),
				...
				'woocommerce_single_product_title' => array(
					'label' => esc_html__( 'Woocommerce: Single Product Title', 'gustablo' ),
				...
				'woocommerce_single_price' => array(
					'label' => esc_html__( 'Woocommerce: Single Price Amount', 'gustablo' ),
				...
				'woocommerce_single_tab_title' => array(
					'label' => esc_html__( 'Woocommerce: Single Tab Title', 'gustablo' ),
					'target' => '.woo-single-post-class .woocommerce-tabs ul li > a',
					'exclude' => array( 'font-color' ),
					'active_callback' => 'wprt_cac_has_woo',
				),
				'woocommerce_button' => array(
					'label' => esc_html__( 'Woocommerce: Buttons', 'gustablo' ),
		...
		public static function register ( $wp_customize ) {
			...
			$wp_customize->add_panel( 'wprt_typography', array(
				...
				'title' => esc_html__( 'Typography', 'gustablo' ),
			) );
			...
			$wp_customize->add_control( new WPRT_Customize_Multicheck_Control( $wp_customize, 'google_font_subsets', array(
				'label' => esc_html__( 'Font Subsets', 'gustablo' ),
				...
				if ( $label ) {
					...
					if ( in_array( 'font-family', $attributes ) ) {
						...
						$wp_customize->add_control( new WPRT_Fonts_Dropdown_Custom_Control( $wp_customize, $element .'_typography[font-family]', array(
								'label' => esc_html__( 'Font Family', 'gustablo' ),
					...
					if ( in_array( 'font-weight', $attributes ) ) {
						$wp_customize->add_setting( $element .'_typography[font-weight]', array(
							'type' => 'theme_mod',
							'description' => esc_html__( 'Note: Not all Fonts support every font weight style.', 'gustablo' ),
							'sanitize_callback' => false,
							'transport' => $transport,
						) );
						$wp_customize->add_control( $element .'_typography[font-weight]', array(
							'label' => esc_html__( 'Font Weight', 'gustablo' ),
							'section' => 'wprt_typography_'. $element,
							...
							'choices' => array(
								...
								'100' => esc_html__( 'Extra Light: 100', 'gustablo' ),
								'200' => esc_html__( 'Light: 200', 'gustablo' ),
								'300' => esc_html__( 'Book: 300', 'gustablo' ),
								'400' => esc_html__( 'Normal: 400', 'gustablo' ),
								'500' => esc_html__( 'Medium: 500', 'gustablo' ),
								'600' => esc_html__( 'Semibold: 600', 'gustablo' ),
								'700' => esc_html__( 'Bold: 700', 'gustablo' ),
								'800' => esc_html__( 'Extra Bold: 800', 'gustablo' ),
								'900' => esc_html__( 'Black: 900', 'gustablo' ),
							),
							'description' => esc_html__( 'Important: Not all fonts support every font-weight.', 'gustablo' ),
						) );
					}
					...
					if ( in_array( 'font-style', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[font-style]', array(
							'label' => esc_html__( 'Font Style', 'gustablo' ),
							'section' => 'wprt_typography_'. $element,
							...
							'choices' => array(
								'' => esc_html__( 'Default', 'gustablo' ),
								'normal' => esc_html__( 'Normal', 'gustablo' ),
								'italic' => esc_html__( 'Italic', 'gustablo' ),
							),
						) );
					}
					...
					if ( in_array( 'text-transform', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[text-transform]', array(
							'label' => esc_html__( 'Text Transform', 'gustablo' ),
							'section' => 'wprt_typography_'. $element,
							...
							'choices' => array(
								'' => esc_html__( 'Default', 'gustablo' ),
								'capitalize' => esc_html__( 'Capitalize', 'gustablo' ),
								'lowercase' => esc_html__( 'Lowercase', 'gustablo' ),
								'uppercase' => esc_html__( 'Uppercase', 'gustablo' ),
							),
						) );
					}
					...
					if ( in_array( 'font-size', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[font-size]', array(
							'label' => esc_html__( 'Font Size', 'gustablo' ),
							'section' => 'wprt_typography_'. $element,
							'settings' => $element .'_typography[font-size]',
							'priority' => 5,
							'type' => 'text',
							'description' => esc_html__( 'Value in px or em.', 'gustablo' ),
							'active_callback' => $active_callback,
						) );
					}
					...
					if ( in_array( 'font-color', $attributes ) ) {
						...
						$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $element .'_typography_color', array(
							'label' => esc_html__( 'Font Color', 'gustablo' ),
							'section' => 'wprt_typography_'. $element,
					...
					if ( in_array( 'line-height', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[line-height]',
							array(
								'label' => esc_html__( 'Line Height', 'gustablo' ),
								'section' => 'wprt_typography_'. $element,
					...
					if ( in_array( 'letter-spacing', $attributes ) ) {
						...
						$wp_customize->add_control( new WP_Customize_Control( $wp_customize, $element .'_typography_letter_spacing', array(
							'label' => esc_html__( 'Letter Spacing', 'gustablo' ),
							'section' => 'wprt_typography_'. $element,
