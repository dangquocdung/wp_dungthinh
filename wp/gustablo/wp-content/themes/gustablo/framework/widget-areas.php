				...
				<div id="wprt-add-widget" class="widgets-holder-wrap">
				 <div class="">
				  ...
				  <div class="sidebar-name">
				   <h3><?php esc_html_e( 'Create a Widget Area', 'gustablo' ); ?> <span class="spinner"></span></h3>
				  </div>
				  <div class="sidebar-description">
					<form id="addWidgetAreaForm" action="" method="post">
					  <div class="widget-content">
						<input id="wprt-add-widget-input" name="wprt-add-widget-input" type="text" class="regular-text" title="<?php esc_attr_e( 'Name', 'gustablo' ); ?>" placeholder="<?php esc_attr_e( 'Name', 'gustablo' ); ?>" />
					  </div>
					  <div class="widget-control-actions">
						<div class="aligncenter">
						  <input class="addWidgetArea-button button-primary" type="submit" value="<?php esc_attr_e( 'Create Widget Area', 'gustablo' ); ?>" />
						</div>
						<br class="clear">
					  </div>
					</form>
		...
		public function scripts() {
			...
			wp_localize_script(
				...
				array(
					...
					'delete'  => esc_html__( 'Delete', 'gustablo' ),
					'confirm' => esc_html__( 'Confirm', 'gustablo' ),
					'cancel'  => esc_html__( 'Cancel', 'gustablo' ),
				)
			);
		}
