...
function wprt_theme_setup() {
	...
	load_theme_textdomain( 'gustablo', get_template_directory() . '/languages' );
	...
	add_image_size( 'wprt-post-standard', 880, 510, true );
	add_image_size( 'wprt-post-grid', 600, 454, true );
	add_image_size( 'wprt-post-list', 600, 498, true );
	add_image_size( 'wprt-post-widget', 150, 150, true );

	// Register menus
	register_nav_menu( 'top', esc_html__( 'Top Menu', 'gustablo' ) );
	register_nav_menu( 'primary', esc_html__( 'Primary Menu', 'gustablo' ) );
	register_nav_menu( 'about', esc_html__( 'About Menu', 'gustablo' ) );
	register_nav_menu( 'service', esc_html__( 'Service Menu', 'gustablo' ) );
	register_nav_menu( 'bottom', esc_html__( 'Bottom Menu', 'gustablo' ) );
...
add_action( 'widgets_init', 'wprt_sidebars_init' );
function wprt_sidebars_init() {
	// Sidebar for Blog
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Blog', 'gustablo' ),
		'id'            => 'sidebar-blog',
		'description'   => esc_html__( 'Add widgets here to appear in Sidebar Blog.', 'gustablo' ),
	...
	// Sidebar for Pages
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Page', 'gustablo' ),
		'id'			=> 'sidebar-page',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Page', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Portfolio', 'gustablo' ),
		'id'			=> 'sidebar-portfolio',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Portfolio', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	// Sidebar for Shop
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Shop', 'gustablo' ),
		'id'			=> 'sidebar-shop',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Shop', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 1', 'gustablo' ),
		'id'			=> 'sidebar-footer-1',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 1', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 2', 'gustablo' ),
		'id'			=> 'sidebar-footer-2',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 2', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 3', 'gustablo' ),
		'id'			=> 'sidebar-footer-3',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 3', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 4', 'gustablo' ),
		'id'			=> 'sidebar-footer-4',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 4', 'gustablo' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
