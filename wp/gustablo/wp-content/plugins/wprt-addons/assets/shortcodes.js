;(function($) {
    ...
    var eventCube = function() {
        if ( $().cubeportfolio ) {
            $('.wprt-news-event').each(function() {
                var $this = $(this);

                $(this).find('#events').cubeportfolio({
                    filters: '#food-filter',
                    layoutMode: 'grid',
                    defaultFilter: '*',
                    animationType: 'quicksand',
    ...
    var popupImages = function() {
        if ( $().magnificPopup ) {
            $('.wprt-gallery, .gallery-related').each(function () {
        ...
        $(window).on('load resize', function() {
            ...
            $('.wprt-content-box').each(function(){
                if ( mode == 'desktop' ) {
                    ...
                    $(this).children('.inner-wrap').css({padding : $(this).data('padding')});
                } else if ( mode == 'mobile' ) {
                    $(this).css({margin : $(this).data('mobimargin')});
                    $(this).children('.inner-wrap').css({padding : $(this).data('mobipadding')});
                }
            })
        });
    };
    ...
    var gridBox = function() {
        $(".wprt-grid-box > div").wrap('<div class="grid-item">');
        var item = $(".wprt-grid-box > .grid-item");
