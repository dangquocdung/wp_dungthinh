...
if ( $line_1_full == 'yes' ) {
	$css1 = 'height:' . $line1_height . 'px; width: '. $line1_width .'; margin-top: -'. $line_1_top .'px;';
} else {
	$css1 = 'height:' . $line1_height . 'px; width: '. $line1_width .'px;' . $margin1_left .'; margin-top: -'. $line_1_top .'px;';
}

if ( $line_2_full == 'yes' ) {
	$css2 = 'height:' . $line2_height . 'px; width: '. $line2_width .'; margin-top: -'. $line_2_top .'px;';
} else {
	$css2 = 'height:' . $line2_height . 'px; width: '. $line2_width .'px;' . $margin2_left .'; margin-top: -'. $line_2_top .'px;';
}

if ( $line1_color == '#fd4100' ) {
	$cls1 .= ' accent';
} else {
	if ( $line1_color ) $css1 .= 'background-color:'. $line1_color .';';	
}

if ( $line2_color == '#fd4100' ) {
	$cls2 .= ' accent';
} else {
	if ( $line2_color ) $css2 .= 'background-color:'. $line2_color .';';	
}
...
printf(
	'<div class="wprt-lines clearfix %4$s" style="%1$s">
		<div class="line-1 %5$s" style="%2$s"></div>
		<div class="line-2 %6$s" style="%3$s"></div>
	</div>', 
	$css, $css1, $css2, $lines_cls, $cls1, $cls2
);