...
if ( ! empty( $images ) ) {
	...
	for ( $i=0; $i<count($images); $i++ ) {
		...
		$html .= sprintf('<div class="cbp-item"><div class="item-wrap"><a class="zoom-popup cbp-lightbox" href="%2$s"><i class="gustablo-magnifier2"></i></a><img src="%1$s" alt="image" /></div></div>',
			$img_b[0],
			$img_f[0]
		);
	}
