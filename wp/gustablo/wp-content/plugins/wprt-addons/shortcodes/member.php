		            ...
		            <?php if ( has_post_thumbnail() ) : ?>
                 	...
                 	<?php if ( wprt_metabox( 'name' ) || wprt_metabox( 'position' ) || wprt_metabox( 'text' ) ) : ?>
                 		<div class="text-wrap" style="<?php echo esc_attr($content_css); ?>">
				        	...
				        	if ( wprt_metabox( 'facebook' ) )
			        		$socials_html .= '<li class="facebook"><a target="_blank" href="'. esc_url( wprt_metabox( 'facebook' ) ) .'"><i class="gustablo-facebook"></i></a></li>';

			        		if ( wprt_metabox( 'twitter' ) )
			        		$socials_html .= '<li class="twitter"><a target="_blank" href="'. esc_url( wprt_metabox( 'twitter' ) ) .'"><i class="gustablo-twitter"></i></a></li>';

			        		if ( wprt_metabox( 'linkedin' ) )
			        		$socials_html .= '<li class="linkedin"><a target="_blank" href="'. esc_url( wprt_metabox( 'linkedin' ) ) .'"><i class="gustablo-linkedin"></i></a></li>';

			        		if ( wprt_metabox( 'google_plus' ) )
			        		$socials_html .= '<li class="google-plus"><a target="_blank" href="'. esc_url( wprt_metabox( 'google_plus' ) ) .'"><i class="gustablo-googleplus"></i></a></li>';

			        		if ( wprt_metabox( 'instagram' ) )
			        		$socials_html .= '<li class="instagram"><a target="_blank" href="'. esc_url( wprt_metabox( 'instagram' ) ) .'"><i class="gustablo-instagram"></i></a></li>';
				        	$socials_html .= '</ul>';
