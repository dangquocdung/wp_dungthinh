...
function leadinjection_vc_iconpicker_base_register_css(){
    wp_enqueue_style('extraicon', plugin_dir_url( __FILE__ ) . '/assets/theme-icons.css');
}
...
function vc_iconpicker_type_extraicon() {
    return array(
		array("nz-bowl" => "bowl"),
		array("nz-bread" => "bread"),
		array("nz-burger" => "burger"),
		array("nz-chef" => "chef"),
		array("nz-cherries" => "cherries"),
		array("nz-chicken" => "chicken"),
		array("nz-cleaver" => "cleaver"),
		array("nz-cocktail1" => "cocktail1"),
		array("nz-cocktail2" => "cocktail2"),
		array("nz-coffee1" => "coffee1"),
		array("nz-coffee2" => "coffee2"),
		array("nz-coffee3" => "coffee3"),
		array("nz-coffee4" => "coffee4"),
		array("nz-corkscrew" => "corkscrew"),
		array("nz-cutlery" => "cutlery"),
		array("nz-dinner" => "dinner"),
		array("nz-donut" => "donut"),
		array("nz-fish" => "fish"),
		array("nz-fishbones" => "fishbones"),
		array("nz-carrot" => "carrot"),
		array("nz-grill" => "grill"),
		array("nz-drinks" => "drinks"),
		array("nz-ham-leg" => "ham-leg"),
		array("nz-hot-meal-sign" => "hot-meal-sign"),
		array("nz-pepper" => "pepper"),
		array("nz-sushi" => "sushi"),
		array("nz-jar" => "jar"),
		array("nz-kettle" => "kettle"),
		array("nz-kitchen" => "kitchen"),
		array("nz-meal" => "meal"),
		array("nz-mitten" => "mitten"),
		array("nz-muffin" => "muffin"),
		array("nz-pizza1" => "pizza1"),
		array("nz-pizza2" => "pizza2"),
		array("nz-platter" => "platter"),
		array("nz-popsicle" => "popsicle"),
		array("nz-pot" => "pot"),
		array("nz-restaurant" => "restaurant"),
		array("nz-turkey" => "turkey"),
		array("nz-salad" => "salad"),
		array("nz-saucepan" => "saucepan"),
		array("nz-sausage" => "sausage"),
		array("nz-soft-drink" => "soft-drink"),
		array("nz-tea-cup" => "tea-cup"),
		array("nz-tea-pot" => "tea-pot"),
		array("nz-leaves" => "leaves"),
		array("nz-wine-glass" => "wine-glass")
    );
}
...
add_action( 'vc_before_init', function() {
    vc_map( array(
        'name' => esc_html__('Galleries Carousel', 'thecraft'),
        'description' => esc_html__('Displaying gallery posts in carousel.', 'thecraft'),
        'base' => 'galleries',
		'weight'	=>	180,
        'icon' => plugins_url('assets/icon.png', __FILE__),
        'category' => esc_html__('WPRT VC Addons', 'thecraft'),
...
add_action( 'vc_before_init', function() {
    vc_map( array(
        'name' => esc_html__('Galleries Grid', 'thecraft'),
        'description' => esc_html__('Displaying gallery posts in grid with filter bar.', 'thecraft'),
        'base' => 'galleriesgrid',
		'weight'	=>	180,
        'icon' => plugins_url('assets/icon.png', __FILE__),
        'category' => esc_html__('WPRT VC Addons', 'thecraft'),
...
add_action( 'vc_before_init', function() {
    vc_map( array(
        'name' => esc_html__('Food Menu', 'thecraft'),
        'description' => esc_html__('Displaying menu with foods.', 'thecraft'),
        'base' => 'foodmenu',
		'weight'	=>	180,
        'icon' => plugins_url('assets/icon.png', __FILE__),
        'category' => esc_html__('WPRT VC Addons', 'thecraft'),
...
add_action( 'vc_before_init', function() {
	vc_map( array(
	    ...
	    'params' => array(
	        ...
	        array(
				'type' => 'textfield',
				'heading' => esc_html__('Image Width (Required)', 'thecraft'),
...
add_action( 'vc_before_init', function() {
	vc_map( array(
	    'name' => esc_html__('News Event', 'thecraft'),
	    'description' => esc_html__('Displaying blog posts in event style.', 'thecraft'),
	    'base' => 'newsevent',
		'weight'	=>	180,
	    'icon' => plugins_url('assets/icon.png', __FILE__),
	    'category' => esc_html__('WPRT VC Addons', 'thecraft'),
    ...
    'description' => esc_html__('Displaying Accordion', 'thecraft'),
		...
		'params'      => array(
			...
			array(
				...
				'value' => array(
					esc_html__( '', 'thecraft' ) => '',
					esc_html__( 'Restaurant Icons', 'thecraft' ) => 'extraicon',
...
add_action( 'vc_before_init', function() {
	vc_map( array(
		'name' => esc_html__( 'Images Grid or Slider', 'thecraft' ),
		'description' => esc_html__('Displaying images in masonry or slider.', 'thecraft'),
		'base' => 'imagesgrid',
		'weight'	=>	180,
		'icon' => plugins_url('assets/icon.png', __FILE__),
        'category' => esc_html__('WPRT VC Addons', 'thecraft'),
...
add_action( 'vc_before_init', function() {
    vc_map( array(
        ...
        'params' => array(
			...
			array(
				'type'       => 'dropdown',
				'heading'    => esc_html__( 'Background Content', 'thecraft' ),
...
add_action( 'vc_before_init', function() {
    vc_map( array(
        'name' => esc_html__('Products Grid', 'thecraft'),
        'description' => esc_html__('Displaying products in grid.', 'thecraft'),
        'base' => 'dproductsgrid',
		'weight'	=>	180,
        'icon' => plugins_url('assets/icon.png', __FILE__),
        'category' => esc_html__('WPRT VC Addons', 'thecraft'),
        'params' => array(
			...
			array(
				'type'       => 'dropdown',
				'heading'    => esc_html__( 'Columns', 'thecraft' ),
				'param_name' => 'column',
				'value'      => array(
					'2 Columns' => '2c',
					'3 Columns' => '3c',
...
add_action( 'vc_before_init', function() {
	vc_map( array(
		...
		'params'      => array(
			...
			array(
				'type'       => 'dropdown',
				'heading'    => esc_html__( 'Tag: Heading Content', 'thecraft' ),
				'param_name' => 'tag',
				'value'      => array(
					'H1' => 'h1',
					'H2' => 'h2',
			...
			array(
				'type' 		=> 'textarea_html',
				'heading' 	=> esc_html__('Heading Content', 'thecraft'),
				'param_name' 	=> 'content',
				'value' 		=> '',
				'holder' => 'div',
			),
            array(
				'type' => 'colorpicker',
				'heading' => esc_html__('Heading Content: Color', 'thecraft'),
				'param_name' => 'content_color',
				'value' => '',
            ),
            array(
				'type' => 'textfield',
				'heading' => esc_html__('Heading: Max Width', 'thecraft'),
