...
if(!empty($au_listing_ids))  {
    ...
    if( !empty($bk_show_status) ){
        ...
        $auMetasNew[] = $auMetas;
        $auMetasNew['relation'] = 'AND';

        $meta_queries[] = $auMetasNew;
    }else{
        $meta_queries[] = $auMetas;
    }
        ...
        <div class="dashboard-bookings-grid">
            ...
            if($posts_query->have_posts()) :
                ...
                <div id="booking-<?php the_ID(); ?>" <?php post_class('dashboard-card dashboard-booking-item'); ?>>
                    ...
                    <div class="booking-list-contr"><?php if( $current_user->ID == $listing_author_id ): ?>
                        <?php 
                        ...
                        <?php endif; ?>
                        <?php if( $lb_status != 'canceled' && $lb_status != 'completed' ): ?>
                        ...
                        <?php endif; ?><?php elseif( $lb_status != 'canceled' ): // for booked user ?><a href="#" class="cancel-bg tolt cancel-booking" data-microtip-position="left" data-tooltip="<?php esc_attr_e( 'Cancel', 'townhub-add-ons' ); ?>" data-id="<?php echo get_the_ID();?>" data-title="<?php echo esc_attr( get_the_title() ); ?>"><i class="fal fa-ban"></i></a><?php endif; ?></div>
