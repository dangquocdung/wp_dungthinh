...
final class TownHub_Addons { 
    ...
    public function init_scheduler(){
        if ( function_exists('as_next_scheduled_action') && function_exists('as_schedule_recurring_action') && false === as_next_scheduled_action( 'townhub_expire_scheduler_action' ) ) {
