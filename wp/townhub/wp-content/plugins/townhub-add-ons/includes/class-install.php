...
class Esb_Class_Install{
    ...
    public static function update(){
        ...
        if(!wp_doing_ajax()){
            ...
            if( version_compare(get_option( 'townhub-addons-version' ), '1.4.0', '<') ){
                self::lmenu_id();
                update_option( 'townhub-addons-version', '1.4.0' );
            }

            if( version_compare(get_option( 'townhub-addons-version' ), '1.3.6', '<') ){
                
                self::leventdate_start();
                update_option( 'townhub-addons-version', '1.3.6' );
            }
