            ...
            <div class="container">
                ...
                <div class="lcheckout-wrap">
                    ...
                    <?php else: 
                        ...
                        $need_logged_in = ($ck_type === 'listing_booking') ? townhub_addons_get_option('ck_book_logged_in') : townhub_addons_get_option('ck_need_logged_in') ;
        ...
        <div class="cart-details_text">
            <ul class="cart-listi">
                ...
                <?php if (!empty($data['slots'])):
                 ...
                 ?>
                    <li class="clearfix bk-slots"><?php esc_html_e( 'Time Slots', 'townhub-add-ons' ); ?><div class="cart-dtright"><?php echo implode("<br />", $tSlots ); ?></div></li>
                <?php endif ?>
