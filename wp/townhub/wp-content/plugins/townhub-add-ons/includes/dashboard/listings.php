...
function townhub_addons_get_edit_listing_callback() {    
    ...
    if( empty($allow_types) ){
        ...
        $json['error'] = __( 'You are not allowed to submit listing to this type.', 'townhub-add-ons' ) ; 
        wp_send_json($json );
    ...
    if( is_numeric($user_id) && $user_id > 0 ){
        ...
        // }else{
            ...
            $json['post'] = array(
                'lid'                       => $lid,
                'title'                     =>  get_the_title( $lid ), // https://www.tipsandtricks-hq.com/how-to-fix-the-character-encoding-problem-in-wordpress-1480
                ...
                'working_hours'             => Esb_Class_Listing_CPT::wkhours($lid),
