...
<div class="<?php echo $classes; ?>" <?php echo $el_id;?>>
    ...
    <div class="ajax-modal-media fl-wrap">
        ...
        <div class="ajax-modal-photos-btn dynamic-gal" data-dynamicPath='<?php echo json_encode($gMoreImages);?>'><?php echo sprintf(__( 'Photos (<span>%s</span>)', 'townhub-add-ons' ), count($gallery_imgs_room) ) ?></div>
    </div>
</div>
<?php endif ?>
