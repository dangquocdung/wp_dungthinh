    ...
    <div id="main-theme" class="is-hide-loader">
        ...
        <div class="cs-wrapper fl-wrap">
            ...
            <div class="container small-container">
                ...
                <?php if(townhub_addons_get_option('coming_soon_date') != ''){ ?>
                <!-- countdown -->
                <div class="countdown fl-wrap countdown-widget" data-countdate="<?php echo esc_attr( townhub_addons_get_option('coming_soon_date') ); ?>" data-counttime="<?php echo esc_attr( townhub_addons_get_option('coming_soon_time') ); ?>" data-tz="<?php echo esc_attr( townhub_addons_get_option('coming_soon_tz') ); ?>">
