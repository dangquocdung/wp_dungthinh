...
class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
     ...
     * @var object
     */
    public $theme_option_name = 'architect_option'; //set theme options name here - Davis change		
	...
	public function set_demo_menus() {
		...
		set_theme_mod( 'nav_menu_locations', array(
				...
				'footermenu' => $footer_menu->term_id, // - Davis change
				'leftmenu' => $left_menu->term_id, // - Davis change
				'rightmenu' => $right_menu->term_id, // - Davis change
				'shopmenu' => $shop_menu->term_id, // - Davis change				
            )
        );
	}
