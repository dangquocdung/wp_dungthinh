...
function blogosphere_related_products_args($args) {
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
	...
	<div class="cmsmasters_single_product">
		...
		<div class="summary entry-summary cmsmasters_product_right_column">
			<div class="cmsmasters_product_content">
				...
				blogosphere_woocommerce_rating('cmsmasters_theme_icon_star_empty', 'cmsmasters_theme_icon_star_full');
	...
	<?php
		if ($cmsmasters_layout != 'fullwidth') {
			add_filter('woocommerce_output_related_products_args', 'blogosphere_related_products_args');
		}
