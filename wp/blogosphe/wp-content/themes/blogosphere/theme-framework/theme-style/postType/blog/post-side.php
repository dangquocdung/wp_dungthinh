...
?>
<!-- Start Post Side Article -->
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_post_default cmsmasters_side_type'); ?>>
	<?php 
	if (
		...
		echo '<div class="cmsmasters_post_image_wrapper">';
			...
			if ($cmsmasters_post_format == 'image') {
				...
				blogosphere_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'cmsmasters-post-side-thumbnail');
			} elseif ($cmsmasters_post_format == '' && !post_password_required() && has_post_thumbnail()) {
				blogosphere_thumb(get_the_ID(), 'cmsmasters-post-side-thumbnail', true, false, false, false, false, true, false);
