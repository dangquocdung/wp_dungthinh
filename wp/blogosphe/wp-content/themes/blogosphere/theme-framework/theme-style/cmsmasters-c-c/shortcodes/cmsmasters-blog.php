...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'blogosphere');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'blogosphere');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'blogosphere');
...
$out .= '<div class="blog ' . 
	...
	(($puzzle_columns !== '') ? ' cmsmasters_' . esc_attr($puzzle_columns) : '') . 
'">';
...
if ($query->have_posts()) : 
	while ($query->have_posts()) : $query->the_post();
		if ($layout == 'columns') {
			...
			$out .= cmsmasters_composer_ob_load_template('theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/postType/blog/post-' . $layout . '.php', $this->blog_atts);
		} else {
