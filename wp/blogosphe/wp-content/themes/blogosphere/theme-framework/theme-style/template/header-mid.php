...
echo '<div class="header_mid" data-height="' . esc_attr($cmsmasters_option['blogosphere' . '_header_mid_height']) . '">' . 
	'<div class="header_mid_outer">' . 
		'<div class="header_mid_inner">';
			do_action('cmsmasters_before_header_mid', $cmsmasters_option);
			
			if (
				$cmsmasters_option['blogosphere' . '_header_styles'] == 'default' ||
				$cmsmasters_option['blogosphere' . '_header_styles'] == 'r_nav' ||
				$cmsmasters_option['blogosphere' . '_header_styles'] == 'c_nav'
			) {
				echo '<div class="header_mid_inner_right">';
			}
			...
			if ($cmsmasters_option['blogosphere' . '_header_styles'] != 'default') { 
				if (
					$cmsmasters_option['blogosphere' . '_header_add_cont'] == 'cust_html' && 
					$cmsmasters_option['blogosphere' . '_header_add_cont_cust_html'] !== ''
				) {
					echo '<div class="slogan_wrap">' . 
						'<div class="slogan_wrap_inner">' . 
							'<div class="slogan_wrap_text">' . 
								stripslashes($cmsmasters_option['blogosphere' . '_header_add_cont_cust_html']) . 
							'</div>' . 
						'</div>' . 
					'</div>';
				} elseif (
					$cmsmasters_option['blogosphere' . '_header_add_cont'] == 'social' && 
