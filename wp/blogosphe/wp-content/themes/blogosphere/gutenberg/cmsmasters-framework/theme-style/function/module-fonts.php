...
function blogosphere_gutenberg_module_fonts($custom_css = '', $is_editor = false) {
...
add_filter('blogosphere_theme_fonts_filter', 'blogosphere_gutenberg_module_fonts');
