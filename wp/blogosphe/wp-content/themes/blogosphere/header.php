...
<?php blogosphere_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php blogosphere_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<div id="middle">
<?php 
blogosphere_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = blogosphere_theme_page_layout_scheme();
