...
global $theme_option;
$logo1 = $theme_option['logo_footer']['url'];
/**
...
$output .= '<div><div ' . implode( ' ', $wrapper_attributes ) . '>';
if ( $fullwidth != 'true' ) {
    $output .= '<div class="container">';
}
$output .= wpb_js_remove_wpautop( $content );
        ...
        <div class="container">
            <div class="twelve columns"> 
                <div class="footer-bottom">
                    <p><small>'.htmlspecialchars_decode($theme_option['footer_text']).'</small></p>
                    <a href="'.esc_url(home_url()).'"><img src="'.esc_url($logo1).'" alt=""/></a>
                </div>
            </div>
        </div>
    </div>';
