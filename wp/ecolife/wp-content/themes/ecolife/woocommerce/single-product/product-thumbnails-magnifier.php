    ...
    <div class="thumbnails <?php if($enable_slider){ echo 'slider';} else { echo 'noslider';} ?>">
        <div class="thumbnails-inner">
            ...
            foreach ( $attachment_ids as $attachment_id ) {
                ...
                echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<li class="%s"><a onclick="changeActive(jQuery(this));" href="%s" class="%s" title="%s" data-small="%s">%s</a></li>', $image_class, $magnifier_url, $image_class, $image_title, $thumbnail_url, $image ), $attachment_id, $post->ID, $image_class );
