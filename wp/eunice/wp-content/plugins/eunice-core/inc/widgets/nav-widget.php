...
class eunice_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'ence-navigation-widget',
      VTHEME_NAME_P . esc_html__( ': Navigation', 'eunice-core' ),
      array(
        'classname'   => 'ence-navigation-widget',
        'description' => VTHEME_NAME_P . esc_html__( ' widget that displays navigations list.', 'eunice-core' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'eunice-core' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'eunice-core' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'eunice-core' ),
    );
  ...
  public function widget( $args, $instance ) {
    ...
    $nav_menu_args = array(
      ...
      'menu'        => $nav_list,
      'depth'       => $nav_child,
      'items_wrap'  => '<ul id="%1$s" class="%2$s ence-sidenav">%3$s</ul>',
    );
...
function eunice_navigation_widget_function() {
  register_widget( "eunice_navigation_widget" );
}
add_action( 'widgets_init', 'eunice_navigation_widget_function' );
