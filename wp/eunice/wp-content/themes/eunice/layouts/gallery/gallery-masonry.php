...
?>
<div class="container container-width-990 gallery-vertical portfolio-mesonary">
  <article class="entry-content-warp">
    <div class="entry-content">
      ...
      <div class="gallery-ver content-meta">
        ...
        <?php }
        if( !empty( get_the_term_list( $eunice_id, 'gallery_category', '', ',', '' ) ) ) { ?>
          <li>
            <div class="single-meta">
    ...
    <div class="gallery-single-img  gallery-single-mesonary-list-img">
      <div class="list-img gallery-mesonary-list">
