        ...
        public function render_content() {
            ...
            <label class="tt-customizer-control customizer-media-label">
                ...
                <div class="customizer-media-manager">
                    ...
                    <br>
                    <a href="javascript:;" class="remove"><?php esc_html_e('Remove', 'onetheme'); ?></a>
                </div>
            </label>
            <?php
        }
        ...
        public function render_content() {
            ...
            <label class="tt-customizer-control customizer-media-label">
                ...
                <div class="customizer-media-manager customizer-media-bg">
                    ...
                    <br>
                    <a href="#" class="remove"><?php esc_html_e('Remove', 'onetheme'); ?></a>
                    <span class="customizer-bg-options">
                        <select class="customizer-bg-repeat" data-value="<?php echo esc_attr($bg_repeat); ?>">
                            <option value="repeat"><?php esc_html_e('Repeat', 'onetheme'); ?></option>
                            <option value="repeat-x"><?php esc_html_e('Repeat-X', 'onetheme'); ?></option>
                            <option value="repeat-y"><?php esc_html_e('Repeat-Y', 'onetheme'); ?></option>
                            <option value="no-repeat"><?php esc_html_e('No Repeat', 'onetheme'); ?></option>
                            <option value="cover"><?php esc_html_e('Cover', 'onetheme'); ?></option>
                            <option value="contain"><?php esc_html_e('Contain', 'onetheme'); ?></option>
                        </select>
                        <select class="customizer-bg-position" data-value="<?php echo esc_attr($bg_pos); ?>">
                            <option value="top left"><?php esc_html_e('Top', 'onetheme'); ?> &amp; <?php esc_html_e('Left', 'onetheme'); ?></option>
                            <option value="top center"><?php esc_html_e('Top', 'onetheme'); ?> &amp; <?php esc_html_e('Center', 'onetheme'); ?></option>
                            <option value="top right"><?php esc_html_e('Top', 'onetheme'); ?> &amp; <?php esc_html_e('Right', 'onetheme'); ?></option>
                            <option value="center left"><?php esc_html_e('Center', 'onetheme'); ?> &amp; <?php esc_html_e('Left', 'onetheme'); ?></option>
                            <option value="center center"><?php esc_html_e('Center', 'onetheme'); ?> &amp; <?php esc_html_e('Center', 'onetheme'); ?></option>
                            <option value="center right"><?php esc_html_e('Center', 'onetheme'); ?> &amp; <?php esc_html_e('Right', 'onetheme'); ?></option>
                            <option value="bottom left"><?php esc_html_e('Bottom', 'onetheme'); ?> &amp; <?php esc_html_e('Left', 'onetheme'); ?></option>
                            <option value="bottom center"><?php esc_html_e('Bottom', 'onetheme'); ?> &amp; <?php esc_html_e('Center', 'onetheme'); ?></option>
                            <option value="bottom right"><?php esc_html_e('Bottom', 'onetheme'); ?> &amp;<?php esc_html_e('Right', 'onetheme'); ?></option>
                        </select>
                        <select class="customizer-bg-attach" data-value="<?php echo esc_attr($bg_attach); ?>">
                            <option value="scroll"><?php esc_html_e('Scroll', 'onetheme'); ?></option>
                            <option value="fixed"><?php esc_html_e('Fixed', 'onetheme'); ?></option>
                        </select>
                    </span>
                </div>
            </label>
            ...
            <label class="tt-customizer-control customizer-font-set-label">
                ...
                <div class="tt-customizer-control-content tt-customizer-font-set" data-controller="<?php echo esc_attr($this->id); ?>">
                    ...
                    <select class="customizer-select-box customizer-font-weight" data-value="<?php echo esc_attr($font_weight); ?>" data-key="<?php echo esc_attr($key3); ?>">
                        <option value="100"><?php esc_html_e('Ultra Light', 'onetheme'); ?></option>
                        <option value="300"><?php esc_html_e('Book', 'onetheme'); ?></option>
                        <option value="400"><?php esc_html_e('Regular', 'onetheme'); ?></option>
                        <option value="700"><?php esc_html_e('Bold', 'onetheme'); ?></option>
                        <option value="900"><?php esc_html_e('Ultra Bold', 'onetheme'); ?></option>
                    </select>
                </div>
            </label>
            <?php
            ...
            <label class="tt-customizer-control customizer-import-label">
                ...
                <div class="tt-customizer-control-content tt-customizer-font-set" data-controller="<?php echo esc_attr($this->id); ?>">
                    ...
                    <span style="display:block; text-align:right;">
                        ...
                        <a href="javascript:;" id="customizer_options_import" class="button button-primary"><?php esc_html_e('Import Options', 'onetheme'); ?></a>
                    </span>
                </div>
            </label>
            <?php
