...
class TT_ImportData{
    ...
    public function demo_import_page(){
        ...
        if( isset($_POST, $_POST['template']) && !empty($_POST['template']) ){
            ...
            $msg = '<div id="message" class="updated below-h2" style="display:none;"><h4>'.esc_html__('Demo Data Imported.', 'onetheme').'</h4></div>';
        }
        ...
        if( file_exists($multiple_dir) ){
            ...
            $templates = '<tr>
                            <th scope="row"><label>'.esc_html__('Choose Demo Data:', 'onetheme').'</label></th>
            ...
            $templates = '<tr>
                            ...
                            <tr>
                                <th scope="row"><label>'.esc_html__('Import Attachments:', 'onetheme').'</label></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="download_attachment" value="1" /> 
                                        '.esc_html__('Download image and data attachments. (Only for test usage!)', 'onetheme').'
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label>'.esc_html__('Import customizer options:', 'onetheme').'</label></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="import_theme_options" value="1" /> 
                                        '.esc_html__('Please backup your current setup of your Theme Options.', 'onetheme').'
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label>'.esc_html__('Import Widgets:', 'onetheme').'</label></th>
                                <td>
                                    <label>
                                        <input type="checkbox" name="import_widgets" value="1" /> 
                                        '.esc_html__('Import Demo Site Widgets', 'onetheme').'
                                    </label>
                                </td>
                            </tr>';
        }
        ...
        printf('<div class="wrap">
                ...
                </div>', esc_html__('Demo Data Importer', 'onetheme'), $msg, $templates, esc_html__('Import Demo Data', 'onetheme') );
