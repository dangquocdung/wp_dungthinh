...
function onetheme_get_customizer_options(){
    global $customizer_options;
...
function get_customizer_controls(){
    global $customizer_options;
    if( empty($customizer_options) )
        onetheme_get_customizer_options();
...
class TT_Theme_Customizer{
    ...
    function __construct(){
        $this->items = onetheme_get_customizer_options();
    ...
    public function customizer_enqueue(){
        ...
        wp_enqueue_script('jquery-numeric', esc_url(get_template_directory_uri() . '/framework/admin-assets/jquery.numeric.min.js'), array( 'jquery' ), false, true);
        wp_enqueue_style( 'customizer-style', esc_url(get_template_directory_uri() . '/framework/admin-assets/wp.customizer.css') );
        wp_enqueue_script('customize-script', esc_url(get_template_directory_uri() . '/framework/admin-assets/wp.customizer.js'), false, false, true);
        if( isset($_REQUEST['url'],$_REQUEST['edit']) && !empty($_REQUEST['url']) && $_REQUEST['edit']=='page' ){
            wp_enqueue_script('customize-page-script', esc_url(get_template_directory_uri() . '/framework/admin-assets/wp.customizer.page.js'), false, false, true);
    ...
    public function generate_less(){
        if( isset($_POST['wp_customize']) && $_POST['wp_customize']=="on" ){
            ...
            echo '<style type="text/css">'. esc_html($compiled_css) .'</style>';
        }
    }
