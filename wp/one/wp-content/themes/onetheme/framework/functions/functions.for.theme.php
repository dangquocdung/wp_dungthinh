...
global $onetheme_social_icons;
$onetheme_social_icons = array(
    "facebook" => "facebook",
    "twitter" => "twitter",
    "pinterest" => "pinterest",
    "instagram" => "instagram",
...
if (!function_exists('one_theme_custom_upload_mimes')) {
    add_filter('upload_mimes', 'one_theme_custom_upload_mimes');

    function one_theme_custom_upload_mimes($existing_mimes = array()) {
