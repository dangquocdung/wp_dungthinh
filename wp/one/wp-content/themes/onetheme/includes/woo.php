        ...
        echo '<div class="shop-item">
                    <div class="layer-shop">
                          <div class="vertical-align">
                                <a href="'.esc_url(home_url('/')).'?add-to-cart='.get_the_ID().'" rel="nofollow" data-product_id="'.get_the_ID().'" data-product_sku="" data-quantity="1" class="button add_to_cart_button product_type_simple card-button"><span class="fa fa-shopping-cart"></span>'.esc_html__('add to cart', 'onetheme').'</a>
                          </div>
                    </div>
