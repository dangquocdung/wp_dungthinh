...
add_action( 'show_user_profile', 'onetheme_extra_profile_fields' );
add_action( 'edit_user_profile', 'onetheme_extra_profile_fields' );

function onetheme_extra_profile_fields( $user ) {
	?>
...
add_action( 'personal_options_update', 'onetheme_save_extra_profile_fields' );
add_action( 'edit_user_profile_update', 'onetheme_save_extra_profile_fields' );

function onetheme_save_extra_profile_fields( $user_id ) {
