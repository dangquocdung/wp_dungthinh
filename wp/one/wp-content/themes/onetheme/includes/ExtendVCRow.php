    ...
    public function row_init(){
        if( function_exists('vc_add_param') ){
            ...
            vc_add_param('vc_row', array(
                "type" => "dropdown",
                "heading" => esc_html__("Overlay", 'onetheme'),
                "param_name" => "vc_row_overlay",
                "value" => array(
                        esc_html__("No", 'onetheme') => "no",
                        esc_html__("Yes", 'onetheme') => "yes",
                    )
            ));

            vc_add_param('vc_row', array(
                "type" => "colorpicker",
                "heading" => esc_html__("Overlay Color", 'onetheme'),
            ...
            vc_add_param('vc_row', array(
                "type"      => "textfield",
                "heading"   => esc_html__("Overlay Opacity", 'onetheme'),
            ...
            vc_add_param('vc_row', array(
                "type" => "dropdown",
                "heading" => esc_html__("One Page Section", 'onetheme'),
            ...
            vc_add_param('vc_row', array(
                "type" => "textfield",
                "heading" => esc_html__("Section Label", 'onetheme'),
            ...
            vc_add_param('vc_row', array(
                "type" => "textfield",
                "heading" => esc_html__("Section slug", 'onetheme'),
                "description" => esc_html__("Don't need hash tag (#). You can apply a custom link to redirect.", 'onetheme'),
            ...
            vc_add_param('vc_column', array(
                "type" => "dropdown",
                "heading" => esc_html__("Horizontal Alignment", 'onetheme'),
                "param_name" => "horizontal_align",
                "value" => array(
                        esc_html__("None", 'onetheme') => "none",
                        esc_html__("Left", 'onetheme') => "left",
                        esc_html__("Center", 'onetheme') => "center",
                        esc_html__("Right", 'onetheme') => "right"
                    )
            ));
            vc_add_param('vc_column', array(
                "type" => "dropdown",
                "heading" => esc_html__("Vertical Alignment", 'onetheme'),
                "param_name" => "vertical_align",
                "value" => array(
                        esc_html__("None", 'onetheme') => "none",
                        esc_html__("Top", 'onetheme') => "top",
                        esc_html__("Middle", 'onetheme') => "middle",
                        esc_html__("Bottom", 'onetheme') => "bottom"
                    )
            ));
