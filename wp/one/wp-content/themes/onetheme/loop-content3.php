<?php
        $content_class = 'wpc-short-post style-2 bottom clearfix';
        if (is_single()) {
            $content_class .= 'wpc-short-post clearfix style-2';
        } else {
            $content_class .= '';
        }
    ...
    ?>  
         <!-- post list -->
           <article <?php post_class($content_class); ?>>
                <div class="col-xs-12 col-sm-12 <?php echo esc_attr($col_class);?>">
                ...
                <div class="col-xs-12 col-sm-12 <?php echo esc_attr($col_img_class);?>">
                    <div class="post-content">
                        <section class="post-data">
                            ...
                            <div class="post-date"><i class="fa fa-calendar-o"></i><?php the_time('m D, Y'); ?></div>
