...
if(isset($digitech_opt['sidebarsingleproduct_pos']) && $digitech_opt['sidebarsingleproduct_pos']!=''){
	$singleproductsidebar = $digitech_opt['sidebarsingleproduct_pos'];
}
...
<div id="product-<?php the_ID(); ?>">
	<div class="container">
		<div class="row">
			...
			<div class="col-12 <?php if ( is_active_sidebar( 'sidebar-single_product' ) ) { echo ' col-lg-9'; } ?> product-content">
				<div class="row">
					...
					<div class="col-12 col-lg-7">
						<div class="summary entry-summary single-product-info">
							...
							<div class="single-product-sharing">
								<?php 
								if(function_exists('digitech_product_sharing')) {
									digitech_product_sharing();
								} ?>
							</div>
