...
$shopsidebar = 'left';
if(isset($digitech_opt['sidebarshop_pos']) && $digitech_opt['sidebarshop_pos']!=''){
	$shopsidebar = $digitech_opt['sidebarshop_pos'];
}
...
switch($shoplayout) {
	case 'fullwidth':
		Digitech_Class::digitech_shop_class('shop-fullwidth');
		$shopcolclass = 12;
		$shopsidebar = 'none';
		$productcols = 4;
		break;
	default:
		Digitech_Class::digitech_shop_class('shop-sidebar');
		$shopcolclass = 9;
		$productcols = 3;
}
...
<div class="main-container">
	<div class="shop_content">
		<div class="container shop_content-inner">
			...
			<?php if(isset($digitech_opt['shop_banner']['url']) && ($digitech_opt['shop_banner']['url'])!=''){ ?>
				<div class="shop-banner">
					<img src="<?php echo esc_url($digitech_opt['shop_banner']['url']); ?>" alt="<?php esc_attr_e('Shop banner','digitech') ?>" />
				</div>
			<?php } ?>
			...
			<?php if( is_shop()){ ?>
				<div class="shop_tabs"> 
					...
					?>
						<ul>
							<li class="active"><a href="<?php echo esc_attr($shop_page_url);?>"><?php esc_html_e('All', 'digitech');?></a></li>
							<?php
			...
			<div class="row">
				...
				<div id="archive-product" class="page-content col-12 <?php echo 'col-lg-'.$shopcolclass; ?> <?php echo esc_attr($digitech_viewmode);?> <?php echo esc_attr($shoplayout);?>">
						...
						<?php if ( woocommerce_products_will_display() ) { ?>
							<div class="toolbar">
								<div class="toolbar-inner">
									<div class="view-mode">
										<label><?php esc_html_e('View on', 'digitech');?></label>
										<a href="#" class="grid <?php if($digitech_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'digitech' ); ?>"><?php esc_html_e('Grid', 'digitech');?></a>
										<a href="#" class="list <?php if($digitech_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'digitech' ); ?>"><?php esc_html_e('List', 'digitech');?></a>
									</div>
									<?php
