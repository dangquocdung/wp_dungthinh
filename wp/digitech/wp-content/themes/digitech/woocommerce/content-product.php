...
$digitech_productsfound = Digitech_Class::digitech_shortcode_products_count();
...
<?php if ( ( 0 == ( $woocommerce_loop['loop'] ) % 3 ) && ( $woocommerce_loop['columns'] == 3 ) ) {
	$oven = $woocommerce_loop['loop'] / 3;
	$oven_class = ($oven % 2) == 0 ? 'odd' : 'even';
	echo '<div class="group '. $oven_class .'">';
} ?>
...
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 2 || $digitech_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 2 )  ) { /* for odd case: $digitech_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 3 || $digitech_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 3 )  ) { /* for odd case: $digitech_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 5 || $digitech_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 5 )  ) { /* for odd case: $digitech_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>