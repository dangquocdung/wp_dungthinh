...
?>
		<!--HEADER START-->
        <nav class="header <?php if ( is_singular() && function_exists( 'ot_get_option' ) && get_post_meta($post->ID, 'menu_format', true)!= 'head_standard' && ot_get_option( 'theme_style')!='dark'){ echo 'white-header ';} 
                     ...
                     <div class="container-fluid">
                        ...
                        <div class="logo-clean">
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                            	<?php if ( is_singular() && function_exists( 'ot_get_option' ) && get_post_meta($post->ID, 'menu_format', true)!= 'head_standard' && ot_get_option( 'theme_style')!='dark'){ ?>
