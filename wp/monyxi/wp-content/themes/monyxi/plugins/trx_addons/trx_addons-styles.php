...
if ( !function_exists( 'monyxi_trx_addons_add_theme_vars' ) ) {
	add_filter( 'monyxi_filter_add_theme_vars', 'monyxi_trx_addons_add_theme_vars', 10, 2 );
	function monyxi_trx_addons_add_theme_vars($rez, $vars) {
...
if (!function_exists('monyxi_trx_addons_get_css')) {
	add_filter('monyxi_filter_get_css', 'monyxi_trx_addons_get_css', 10, 2);
	function monyxi_trx_addons_get_css($css, $args) {
...
ul[class*="trx_addons_list"][class*="_circled"] > li a {
	color: {$colors['text']};
}
ul[class*="trx_addons_list"][class*="_circled"] > li a:hover {
	color: {$colors['text_dark']};
}
...
ul[class*="trx_addons_list"][class*="_circled"] > li:hover:before {
	color: {$colors['bg_color']};
...
.scheme_self.footer_wrap .sc_layouts_row_type_compact .widget_contacts .contacts_info span:before,
.scheme_self.footer_wrap .sc_layouts_row_type_compact .widget_contacts .contacts_info > div > a:before,
.scheme_self.footer_wrap .sc_layouts_row_type_compact .widget_contacts .contacts_info > a:before {
	color: {$colors['text']};
}
...
.sc_action_item .sc_button.sc_action_item_link:hover {
...
.sc_blogger_default .slider_outer .slider_pagination_wrap .swiper-pagination-bullet:hover,
.sc_blogger_default .slider_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active {
...
.sc_blogger_modern .sc_blogger_item .post_meta .post_date a:before {
	color: {$colors['text_dark']};
}
...
.sc_icons.sc_icons_module .sc_icons_item:hover .num {
	color: #f4f4f3;
}
...
.sc_testimonials_simple .sc_item_columns_3 .slider-slide .sc_testimonials_item .sc_testimonials_item_content:before {
	color: {$colors['text_dark']};
}
.sc_testimonials_simple .sc_item_columns_3 .slider-slide.swiper-slide-active + .slider-slide .sc_testimonials_item_content:before {
	color: {$colors['alter_link']};
}
.sc_testimonials_simple .slider_outer .swiper-pagination-bullet:hover,
...
.sc_blogger_default .sc_blogger_item .course-categories a {
	color: {$colors['text_dark']};
	background-color: {$colors['text_hover2']};
}
.sc_blogger_default .sc_blogger_item .course-categories a:hover {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sc_blogger_filters .sc_blogger_filters_titles a:hover:after,
.sc_blogger_filters .sc_blogger_filters_titles a.active:after {
	background-color: {$colors['text_hover']};
}
