...
jQuery(document).ready(function() {
	...
	if (window.elementor !== undefined) {
		...
		jQuery('#elementor-panel')
			.on('input change', '[data-setting*="monyxi_options_"]', function (e) {
				...
				if (tab.length > 0 && section_name != '') {
					...
					}, 4500);	// Reload page after the AJAX-call 'Save page options' appear (Elementor call save options after 3000ms)
				}
			});
	}
});