<?php
/*
* Define class AArpr_Utils
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('AArpr_Utils') != true) {
    class AArpr_Utils
    {
        /*
        ...
        */
        public function __construct( $parent, $plugin_alias='' )
        {
            $this->the_plugin = $parent;
			$this->plugin_alias = !empty($plugin_alias) ? $plugin_alias : $this->the_plugin->alias;
        }
        ...
        */
        public static function getInstance( $parent, $plugin_alias='' )
        {
            if (!self::$_instance) {
