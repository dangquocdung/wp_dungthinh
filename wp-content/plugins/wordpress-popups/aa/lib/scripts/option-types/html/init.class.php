<?php
if( !class_exists('AArpr_Option_Type_HTML') ){
	class AArpr_Option_Type_HTML extends AArpr_Settings 
	{
		public $manifest;
		...
		public function __construct( $plugin_alias='', $pms=array() )
		{
			...
			$this->manifest = $this->options['html'];
		}
		...
		protected function _render( $elm_id, $box_id, $val, $attrs ) 
		{
			...
			$html[] = str_replace("__box_id__", $box_id, $attrs['html']);
