 ...
 * @author			 AA-Team
 */
if ( !class_exists('AArpr_aaAmazonWS') ) {
class AArpr_aaAmazonWS
{
	 ...
	 *
	 * @return array|AArpr_aaAmazonWS depends on params argument
	 */
	 ...
	 *
	 * @return string|AArpr_aaAmazonWS depends on country argument
	 */
	 ...
	 *
	 * @return string|AArpr_aaAmazonWS depends on category argument
	 */
	 ...
	 *
	 * @return string|AArpr_aaAmazonWS depends on responseGroup argument
	 */
	 ...
	 *
	 * @return integer|AArpr_aaAmazonWS depends on type argument
	 */
	 ...
	 * @param string $associateTag
	 *
	 * @return string|AArpr_aaAmazonWS depends on associateTag argument
	 */
