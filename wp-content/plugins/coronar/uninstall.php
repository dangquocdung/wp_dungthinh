...
use Merkulove\Coronar\Unity\Cache;
use Merkulove\Coronar\Unity\Helper;
use Merkulove\Coronar\Unity\Plugin;
use Merkulove\Coronar\UninstallHelper;
use Merkulove\Coronar\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_coronar' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_coronar_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_coronar_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
