...
final class TabActivation extends Tab {
	...
	public function display_status() {
		...
		$activation_tab = admin_url( 'admin.php?page=mdp_coronar_settings&tab=activation' );
		?>
	...
	public function render_subscribe() {
        ...
        <div class="mdp-subscribe-form">
            ...
            <h3><?php esc_html_e( 'Subscribe to updates', 'coronar' ); ?></h3>
            <p><?php esc_html_e( 'Sign up for the newsletter to be the first to know about news and discounts.', 'coronar' ); ?></p>
            <p class="mdp-subscribe-form-message"
               data-success="<?php esc_html_e( 'Hurray! We received your Subscription request. Check your inbox for an email from us.', 'coronar' ); ?>"
               data-warn="<?php esc_html_e( 'Oh! Sorry, but we cannot send messages to this email.', 'coronar' ); ?>"
               data-error="<?php esc_html_e( 'Oops! Something went wrong. Please try later.', 'coronar' ); ?>"
            ></p>
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your E-Mail', 'coronar' ),
                '',
                [
	...
	public function render_form() {
        ...
        <div class="mdp-activation-form">
            ...
            UI::get_instance()->render_input(
                $purchase_code,
                esc_html__( 'Purchase code', 'coronar'),
            ...
            <div class="mdc-accordion" data-mdp-accordion="showfirst: true">
                ...
                <div class="mdc-accordion-content">
                    <p>
                        ...
                        <a href="https://merkulove.zendesk.com/hc/en-us/articles/360006100998-Troubleshooting-of-the-plugin-activation" target="_blank"><?php esc_html_e( 'Purchase Code is Not Working', 'coronar' );?></a>
                        <?php esc_html_e( ' .', 'coronar');?>
                    </p>
                </div>
