...
final class PluginHelper {
	...
	public function add_links( $links ) {
		...
		array_unshift( $links, '<a title="' . esc_html__( 'Settings', 'coronar' ) . '" href="' . admin_url( 'admin.php?page=mdp_coronar_settings' ) . '">' . esc_html__( 'Settings', 'coronar' ) . '</a>' );
		$links[] = '<a title="' . esc_html__( 'Documentation', 'coronar' ) . '" href="https://docs.merkulov.design/tag/coronar" target="_blank">' . esc_html__( 'Documentation', 'coronar' ) . '</a>';
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'coronar' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'coronar', false, Plugin::get_path() . '/languages/' );
