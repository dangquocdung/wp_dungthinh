...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/coronar.php';
		...
		self::$menu_bases[] = 'toplevel_page_mdp_coronar_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'coronar' ),
            'title'         => esc_html__( 'General Settings', 'coronar' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'coronar' ),
            'title'         => esc_html__( 'Custom CSS', 'coronar' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'coronar' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'coronar' ),
            'title'         => esc_html__( 'Assignments Settings', 'coronar' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'coronar' ),
            'title'         => esc_html__( 'Plugin Activation', 'coronar' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'coronar' ),
            'title'         => esc_html__( 'System Status', 'coronar' ),
            'show_title'    => true,
            'icon'          => 'info',
            'reports'       => [
                'server'    => [
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'coronar' ),
            'title'         => esc_html__( 'Updates', 'coronar' ),
            'show_title'    => true,
            'icon'          => 'update',
        ];
    ...
    private function add_uninstall_tab() {
        ...
        self::$tabs['uninstall'] = [
            ...
            'label'         => esc_html__( 'Uninstall', 'coronar' ),
            'title'         => esc_html__( 'Uninstall Settings', 'coronar' ),
            'show_title'    => true,
            'icon'          => 'delete_sweep',
            'fields'        => [
                'delete_plugin' => [
                    ...
                    'options'           => [
                        ...
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'coronar' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/coronar.php';
