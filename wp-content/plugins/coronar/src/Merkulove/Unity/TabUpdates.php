...
final class TabUpdates extends Tab {
	...
	public function add_settings() {
		...
		$group = 'Coronar' . self::TAB_SLUG . 'OptionsGroup';
		$section = 'mdp_coronar_' . self::TAB_SLUG . '_page_status_section';

        /** Check for Updates button. */
        add_settings_field( 'check_updates', esc_html__( 'Check for updates:', 'coronar' ), [$this, 'check_updates'], $group, $section );
    ...
    public function check_updates() {
        ...
        UI::get_instance()->render_button(
            esc_html__( 'Check Updates', 'coronar' ),
            '',
            'autorenew',
            [
                "name" => 'mdp_coronar_' . self::TAB_SLUG . '_settings' . "[check_updates]",
                "id" => "mdp-updates-btn",
