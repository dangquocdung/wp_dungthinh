...
final class TabGeneral extends Tab {
	...
	public function add_settings( $tab_slug ) {
        ...
        $group = 'Coronar' . $tab_slug . 'OptionsGroup';
        $section = 'mdp_coronar_' . $tab_slug . '_page_status_section';
     ...
     * @return array
     **/
    private function prepare_general_params( $tab_slug, $key ) {
    ...
    private function prepare_attr( $key, $tab_slug, $field ) {
        ...
        $name = 'mdp_coronar_' . $tab_slug . '_settings';
