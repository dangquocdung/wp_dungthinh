...
final class TabAssignments extends Tab  {
	...
	public function add_admin_scripts() {
        ...
        wp_enqueue_script( 'mdp-coronar-assignments', Plugin::get_url() . 'src/Merkulove/Unity/assets/js/assignments' . Plugin::get_suffix() . '.js', [ 'jquery' ], Plugin::get_version(), true );
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php esc_attr_e( 'mdp_coronar_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
        ...
        <div id="mdp-assign-box">
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-matching-method mdp-margin <?php $this->is_need_to_hide( 'matching_method' ); ?>">
                    ...
                    <p><?php esc_html_e( 'Should all or any assignments be matched?', 'coronar' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-languages mdp-margin <?php $this->is_need_to_hide( 'languages' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Languages', 'coronar' ); ?></h4>
                    ...
                    <div class="languages-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the languages to assign to.', 'coronar' ); ?></p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Operating Systems', 'coronar' ); ?></h4>
                    ...
                    <div class="mdp-os-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the operating systems to assign to. Keep in mind that operating system detection is not always 100% accurate. Users can setup their browser to mimic other operating systems.', 'coronar' ); ?></p>
                        <!--suppress HtmlFormInputWithoutLabel -->
                        <select class="os chosen-select" multiple="">
                            <option value=""></option>
                            <option value="Windows"><?php esc_html_e( 'Windows (All)', 'coronar' ); ?></option>
                            <option value="Windows nt 10.0"><?php esc_html_e( 'Windows 10', 'coronar' ); ?></option>
                            <option value="Windows nt 6.2"><?php esc_html_e( 'Windows 8', 'coronar' ); ?></option>
                            <option value="Windows nt 6.1"><?php esc_html_e( 'Windows 7', 'coronar' ); ?></option>
                            <option value="Windows nt 6.0"><?php esc_html_e( 'Windows Vista', 'coronar' ); ?></option>
                            <option value="Windows nt 5.2"><?php esc_html_e( 'Windows Server 2003', 'coronar' ); ?></option>
                            <option value="Windows nt 5.1"><?php esc_html_e( 'Windows XP', 'coronar' ); ?></option>
                            <option value="Windows nt 5.01"><?php esc_html_e( 'Windows 2000 sp1', 'coronar' ); ?></option>
                            <option value="Windows nt 5.0"><?php esc_html_e( 'Windows 2000', 'coronar' ); ?></option>
                            <option value="Windows nt 4.0"><?php esc_html_e( 'Windows NT 4.0', 'coronar' ); ?></option>
                            <option value="Win 9x 4.9"><?php esc_html_e( 'Windows Me', 'coronar' ); ?></option>
                            <option value="Windows 98"><?php esc_html_e( 'Windows 98', 'coronar' ); ?></option>
                            <option value="Windows 95"><?php esc_html_e( 'Windows 95', 'coronar' ); ?></option>
                            <option value="Windows ce"><?php esc_html_e( 'Windows CE', 'coronar' ); ?></option>
                            <option value="#(Mac OS|Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (All)', 'coronar' ); ?></option>
                            <option value="Mac OS X"><?php esc_html_e( 'Mac OSX (All)', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.11"><?php esc_html_e( 'Mac OSX El Capitan', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.10"><?php esc_html_e( 'Mac OSX Yosemite', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.9"><?php esc_html_e( 'Mac OSX Mavericks', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.8"><?php esc_html_e( 'Mac OSX Mountain Lion', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.7"><?php esc_html_e( 'Mac OSX Lion', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.6"><?php esc_html_e( 'Mac OSX Snow Leopard', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.5"><?php esc_html_e( 'Mac OSX Leopard', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.4"><?php esc_html_e( 'Mac OSX Tiger', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.3"><?php esc_html_e( 'Mac OSX Panther', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.2"><?php esc_html_e( 'Mac OSX Jaguar', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.1"><?php esc_html_e( 'Mac OSX Puma', 'coronar' ); ?></option>
                            <option value="Mac OS X 10.0"><?php esc_html_e( 'Mac OSX Cheetah', 'coronar' ); ?></option>
                            <option value="#(Mac_PowerPC|Macintosh)#"><?php esc_html_e( 'Mac OS (classic)', 'coronar' ); ?></option>
                            <option value="#(Linux|X11)#"><?php esc_html_e( 'Linux', 'coronar' ); ?></option>
                            <option value="OpenBSD"><?php esc_html_e( 'Open BSD', 'coronar' ); ?></option>
                            <option value="SunOS"><?php esc_html_e( 'Sun OS', 'coronar' ); ?></option>
                            <option value="QNX"><?php esc_html_e( 'QNX', 'coronar' ); ?></option>
                            <option value="BeOS"><?php esc_html_e( 'BeOS', 'coronar' ); ?></option>
                            <option value="OS/2"><?php esc_html_e( 'OS/2', 'coronar' ); ?></option>
                        </select>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-browsers mdp-margin <?php $this->is_need_to_hide( 'browsers' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Browsers', 'coronar' ); ?></h4>
                    ...
                    <div class="mdp-browsers-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the browsers to assign to. Keep in mind that browser detection is not always 100% accurate. Users can setup their browser to mimic other browsers.', 'coronar' ); ?></p>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Browsers:', 'coronar' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php esc_html_e( 'Chrome (All)', 'coronar' ); ?></option>
                                    <option value="#Chrome/(6[1-9]|70)\.#"><?php esc_html_e( 'Chrome 61-70', 'coronar' ); ?></option>
                                    <option value="#Chrome/(5[1-9]|60)\.#"><?php esc_html_e( 'Chrome 51-60', 'coronar' ); ?></option>
                                    <option value="#Chrome/(4[1-9]|50)\.#"><?php esc_html_e( 'Chrome 41-50', 'coronar' ); ?></option>
                                    <option value="#Chrome/(3[1-9]|40)\.#"><?php esc_html_e( 'Chrome 31-40', 'coronar' ); ?></option>
                                    <option value="#Chrome/(2[1-9]|30)\.#"><?php esc_html_e( 'Chrome 21-30', 'coronar' ); ?></option>
                                    <option value="#Chrome/(1[1-9]|20)\.#"><?php esc_html_e( 'Chrome 11-20', 'coronar' ); ?></option>
                                    <option value="#Chrome/([1-9]|10)\.#"><?php esc_html_e( 'Chrome 1-10', 'coronar' ); ?></option>
                                    <option value="Firefox"><?php esc_html_e( 'Firefox (All)', 'coronar' ); ?></option>
                                    <option value="#Firefox/(6[1-9]|70)\.#"><?php esc_html_e( 'Firefox 61-70', 'coronar' ); ?></option>
                                    <option value="#Firefox/(5[1-9]|60)\.#"><?php esc_html_e( 'Firefox 51-60', 'coronar' ); ?></option>
                                    <option value="#Firefox/(4[1-9]|50)\.#"><?php esc_html_e( 'Firefox 41-50', 'coronar' ); ?></option>
                                    <option value="#Firefox/(3[1-9]|40)\.#"><?php esc_html_e( 'Firefox 31-40', 'coronar' ); ?></option>
                                    <option value="#Firefox/(2[1-9]|30)\.#"><?php esc_html_e( 'Firefox 21-30', 'coronar' ); ?></option>
                                    <option value="#Firefox/(1[1-9]|20)\.#"><?php esc_html_e( 'Firefox 11-20', 'coronar' ); ?></option>
                                    <option value="#Firefox/([1-9]|10)\.#"><?php esc_html_e( 'Firefox 1-10', 'coronar' ); ?></option>
                                    <option value="MSIE"><?php esc_html_e( 'Internet Explorer (All)', 'coronar' ); ?></option>
                                    <option value="MSIE Edge"><?php esc_html_e( 'Internet Explorer Edge', 'coronar' ); ?></option>
                                    <option value="Edge/15"><?php esc_html_e( 'Edge 15', 'coronar' ); ?></option>
                                    <option value="Edge/14"><?php esc_html_e( 'Edge 14', 'coronar' ); ?></option>
                                    <option value="Edge/13"><?php esc_html_e( 'Edge 13', 'coronar' ); ?></option>
                                    <option value="Edge/12"><?php esc_html_e( 'Edge 12', 'coronar' ); ?></option>
                                    <option value="MSIE 11"><?php esc_html_e( 'Internet Explorer 11', 'coronar' ); ?></option>
                                    <option value="MSIE 10.6"><?php esc_html_e( 'Internet Explorer 10.6', 'coronar' ); ?></option>
                                    <option value="MSIE 10.0"><?php esc_html_e( 'Internet Explorer 10.0', 'coronar' ); ?></option>
                                    <option value="MSIE 10."><?php esc_html_e( 'Internet Explorer 10', 'coronar' ); ?></option>
                                    <option value="MSIE 9."><?php esc_html_e( 'Internet Explorer 9', 'coronar' ); ?></option>
                                    <option value="MSIE 8."><?php esc_html_e( 'Internet Explorer 8', 'coronar' ); ?></option>
                                    <option value="MSIE 7."><?php esc_html_e( 'Internet Explorer 7', 'coronar' ); ?></option>
                                    <option value="#MSIE [1-6]\.#"><?php esc_html_e( 'Internet Explorer 1-6', 'coronar' ); ?></option>
                                    <option value="Opera"><?php esc_html_e( 'Opera (All)', 'coronar' ); ?></option>
                                    <option value="#Opera/(5[1-9]|60)\.#"><?php esc_html_e( 'Opera 51-60', 'coronar' ); ?></option>
                                    <option value="#Opera/(4[1-9]|50)\.#"><?php esc_html_e( 'Opera 41-50', 'coronar' ); ?></option>
                                    <option value="#Opera/(3[1-9]|40)\.#"><?php esc_html_e( 'Opera 31-40', 'coronar' ); ?></option>
                                    <option value="#Opera/(2[1-9]|30)\.#"><?php esc_html_e( 'Opera 21-30', 'coronar' ); ?></option>
                                    <option value="#Opera/(1[1-9]|20)\.#"><?php esc_html_e( 'Opera 11-20', 'coronar' ); ?></option>
                                    <option value="#Opera/([1-9]|10)\.#"><?php esc_html_e( 'Opera 1-10', 'coronar' ); ?></option>
                                    <option value="Safari"><?php esc_html_e( 'Safari (All)', 'coronar' ); ?></option>
                                    <option value="#Version/11\..*Safari/#"><?php esc_html_e( 'Safari 11', 'coronar' ); ?></option>
                                    <option value="#Version/10\..*Safari/#"><?php esc_html_e( 'Safari 10', 'coronar' ); ?></option>
                                    <option value="#Version/9\..*Safari/#"><?php esc_html_e( 'Safari 9', 'coronar' ); ?></option>
                                    <option value="#Version/8\..*Safari/#"><?php esc_html_e( 'Safari 8', 'coronar' ); ?></option>
                                    <option value="#Version/7\..*Safari/#"><?php esc_html_e( 'Safari 7', 'coronar' ); ?></option>
                                    <option value="#Version/6\..*Safari/#"><?php esc_html_e( 'Safari 6', 'coronar' ); ?></option>
                                    <option value="#Version/5\..*Safari/#"><?php esc_html_e( 'Safari 5', 'coronar' ); ?></option>
                                    <option value="#Version/4\..*Safari/#"><?php esc_html_e( 'Safari 4', 'coronar' ); ?></option>
                                    <option value="#Version/[1-3]\..*Safari/#"><?php esc_html_e( 'Safari 1-3', 'coronar' ); ?></option>
                                </select>
                            </div>
                        </div>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Mobile Browsers:', 'coronar' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="mobile-browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="mobile"><?php esc_html_e( 'All', 'coronar' ); ?></option>
                                    <option value="Android"><?php esc_html_e( 'Android', 'coronar' ); ?></option>
                                    <option value="#Android.*Chrome#"><?php esc_html_e( 'Android Chrome', 'coronar' ); ?></option>
                                    <option value="Blackberry"><?php esc_html_e( 'Blackberry', 'coronar' ); ?></option>
                                    <option value="IEMobile"><?php esc_html_e( 'IE Mobile', 'coronar' ); ?></option>
                                    <option value="iPad"><?php esc_html_e( 'iPad', 'coronar' ); ?></option>
                                    <option value="iPhone"><?php esc_html_e( 'iPhone', 'coronar' ); ?></option>
                                    <option value="iPod"><?php esc_html_e( 'iPod Touch', 'coronar' ); ?></option>
                                    <option value="NetFront"><?php esc_html_e( 'NetFront', 'coronar' ); ?></option>
                                    <option value="NokiaBrowser"><?php esc_html_e( 'Nokia', 'coronar' ); ?></option>
                                    <option value="Opera Mini"><?php esc_html_e( 'Opera Mini', 'coronar' ); ?></option>
                                    <option value="Opera Mobi"><?php esc_html_e( 'Opera Mobile', 'coronar' ); ?></option>
                                    <option value="UC Browser"><?php esc_html_e( 'UC Browser', 'coronar' ); ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'IP Addresses', 'coronar' ); ?></h4>
                    ...
                    <div class="mdp-ips-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
                            <?php esc_html_e( 'IP Addresses / Ranges', 'coronar' ); ?><br>
                        </p>

                        <!--suppress HtmlFormInputWithoutLabel -->
                        <textarea class="mdp-ips-field"></textarea>
                        <p>
                            <?php esc_html_e( 'List of IP addresses or IP ranges. Example: ', 'coronar' ); ?><br>
                            <?php esc_html_e( '46.33.233.31', 'coronar' ); ?><br>
                            <?php esc_html_e( '46.0-46.1', 'coronar' ); ?><br>
                            <?php esc_html_e( '46', 'coronar' ); ?>
                        </p>
                    </div>
