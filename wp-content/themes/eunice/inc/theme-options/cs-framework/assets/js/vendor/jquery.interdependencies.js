...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Eunice the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is euniced.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to eunice condition, true show always, false hide always
         *
         */
