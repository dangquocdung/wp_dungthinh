...
var objMargin = {
	top_bar_button_margin: "#top-bar .top-bar-button",
...
var objWidth = {
	...
	site_desktop_container_width: ".site-layout-full-width .weberium-container, .site-layout-boxed #page",
...
var objFontsize = {
	...
	bottom_social_font_size: "#bottom .top-bar-socials .icons a",
}
...
var objLeftMargin = {
	bottom_social_space_between: "#bottom .top-bar-socials .icons a",
}
...
wp.customize('footer_column_gutter', function( value ) {
	var widgets = $( '#footer-widgets' ).children('.weberium-row');
